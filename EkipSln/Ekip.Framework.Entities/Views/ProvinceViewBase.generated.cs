      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{18}{17}- Id: {0}{17}- RowNumber: {1}{17}- AdminId: {2}{17}- ObjectId: {3}{17}- ParentId: {4}{17}- PlateCode: {5}{17}- AreaId: {6}{17}- PhoneCode: {7}{17}- ProvinceName: {8}{17}- Longitude: {9}{17}- Latitude: {10}{17}- Type: {11}{17}- CreateDate: {12}{17}- CreateTime: {13}{17}- UpdateDate: {14}{17}- UpdateTime: {15}{17}- AreaName: {16}{17}", 
				this.Id,
				this.RowNumber,
				this.AdminId,
				this.ObjectId,
