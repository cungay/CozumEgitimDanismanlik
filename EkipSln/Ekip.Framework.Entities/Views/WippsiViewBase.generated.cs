...
{
	///<summary>
	/// An object representation of the 'WippsiView' view. [No description found in the database]	
	///</summary>
	[DataContract]
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("WippsiViewBase")]
	public abstract partial class WippsiViewBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="WippsiViewBase"/> instance.
		///</summary>
		public WippsiViewBase()
		{
		}		
		...
		{
			WippsiView newWippsiView = new WippsiView();
			newWippsiView.SeanceId = _seanceId;
			newWippsiView.ClientId = _clientId;
			newWippsiView.CreateDate = _createDate;
			newWippsiView.SeanceDate = _seanceDate;
			newWippsiView.SeanceTime = _seanceTime;
			newWippsiView.SeanceStatusId = _seanceStatusId;
			newWippsiView.SeanceAdvisorId = _seanceAdvisorId;
			newWippsiView.SeanceAdvisorName = _seanceAdvisorName;
			newWippsiView.TestDate = _testDate;
			newWippsiView.TestAdvisorId = _testAdvisorId;
			newWippsiView.TestAdvisorName = _testAdvisorName;
			newWippsiView.TotalVerbalScore = _totalVerbalScore;
			newWippsiView.TotalPerformanceScore = _totalPerformanceScore;
			newWippsiView.TotalScore = _totalScore;
			return newWippsiView;
		}
		...
		///<summary>
		///  Returns a Typed WippsiViewBase Entity 
		///</summary>
		public virtual WippsiViewBase Copy()
		{
			//shallow copy entity
			WippsiView copy = new WippsiView();
		...
		///<returns>true if toObject is a <see cref="WippsiViewBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(WippsiViewBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="WippsiViewBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="WippsiViewBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="WippsiViewBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(WippsiViewBase Object1, WippsiViewBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(WippsiView entity, string propertyName)
		{
			switch (propertyName)
			{
				case "SeanceId":
		...
		{			
			return GetPropertyValueByName(this as WippsiView, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the WippsiView columns.
	/// </summary>
	[Serializable]
	public enum WippsiViewColumn
	{
		/// <summary>
		/// SeanceID : 
		/// </summary>
