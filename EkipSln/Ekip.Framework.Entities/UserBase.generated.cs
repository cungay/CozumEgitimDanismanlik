...
/*
	...
	Generated on : 19 Aralık 2012 Çarşamba
...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public UserBase(System.String _userName, System.String _password, System.DateTime _createOn, 
		...
		///<param name="_createOn"></param>
		///<param name="_updateOn"></param>
		public static User CreateUser(System.String _userName, System.String _password, System.DateTime _createOn, 
			System.DateTime? _updateOn)
		{
			User newUser = new User();
			newUser.UserName = _userName;
			newUser.Password = _password;
			newUser.CreateOn = _createOn;
			newUser.UpdateOn = _updateOn;
			return newUser;
		}
		...
		public virtual System.DateTime CreateOn
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.CreateOn, this.entityData.CreateOn);
				this.entityData.CreateOn = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.CreateOn, this.entityData.CreateOn);
		...
		public virtual System.DateTime? UpdateOn
		{
			...
			set
			{
				...
				OnColumnChanging(UserColumn.UpdateOn, this.entityData.UpdateOn);
				this.entityData.UpdateOn = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserColumn.UpdateOn, this.entityData.UpdateOn);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"UserID", "UserName", "Password", "CreateOn", "UpdateOn"};
			}
		}
		#endregion 
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{6}{5}- UserId: {0}{5}- UserName: {1}{5}- Password: {2}{5}- CreateOn: {3}{5}- UpdateOn: {4}{5}{7}", 
				this.UserId,
