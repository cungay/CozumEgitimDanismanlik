...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public TeacherBase(System.Int32 _schoolId, System.String _firstName, System.String _lastName, 
			System.String _phone, System.String _gsm, System.String _email, System.String _notes, System.DateTime _createOn, 
			...
			System.DateTime? _updateOn, System.Int32 _createUserId, System.Int32? _updateUserId)
		{
			...
			newTeacher.Notes = _notes;
			newTeacher.CreateOn = _createOn;
			newTeacher.UpdateOn = _updateOn;
		...
		public virtual System.String Notes
		{
			...
			set
			{
				...
				OnColumnChanging(TeacherColumn.Notes, this.entityData.Notes);
				this.entityData.Notes = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(TeacherColumn.Notes, this.entityData.Notes);
		...
		public virtual System.DateTime CreateOn
		{
			...
			set
			{
				...
				OnColumnChanging(TeacherColumn.CreateOn, this.entityData.CreateOn);
				this.entityData.CreateOn = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(TeacherColumn.CreateOn, this.entityData.CreateOn);
		...
		public virtual System.DateTime? UpdateOn
		{
			...
			set
			{
				...
				OnColumnChanging(TeacherColumn.UpdateOn, this.entityData.UpdateOn);
				this.entityData.UpdateOn = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(TeacherColumn.UpdateOn, this.entityData.UpdateOn);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"TeacherId", "SchoolId", "FirstName", "LastName", "Phone", "Gsm", "Email", "Notes", "CreateOn", "UpdateOn", "CreateUserId", "UpdateUserId"};
			}
		}
		#endregion 
		...
		public bool IsPropertyChanged(TeacherColumn column)
		{
			switch(column)
			{
					...
					case TeacherColumn.Notes:
					return entityData.Notes != _originalData.Notes;
					case TeacherColumn.CreateOn:
					return entityData.CreateOn != _originalData.CreateOn;
					case TeacherColumn.UpdateOn:
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{13}{12}- TeacherId: {0}{12}- SchoolId: {1}{12}- FirstName: {2}{12}- LastName: {3}{12}- Phone: {4}{12}- Gsm: {5}{12}- Email: {6}{12}- Notes: {7}{12}- CreateOn: {8}{12}- UpdateOn: {9}{12}- CreateUserId: {10}{12}- UpdateUserId: {11}{12}{14}", 
				this.TeacherId,
				this.SchoolId,
