...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public TeacherBase(System.Int32 _schoolId, System.String _firstName, System.String _lastName, 
			System.String _phone, System.String _gsm, System.String _email, System.DateTime _createOn, System.DateTime? _updateOn, 
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"TeacherId", "SchoolId", "FirstName", "LastName", "Phone", "Gsm", "Email", "CreateOn", "UpdateOn", "CreateUserId", "UpdateUserId"};
			}
		}
		#endregion 
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{12}{11}- TeacherId: {0}{11}- SchoolId: {1}{11}- FirstName: {2}{11}- LastName: {3}{11}- Phone: {4}{11}- Gsm: {5}{11}- Email: {6}{11}- CreateOn: {7}{11}- UpdateOn: {8}{11}- CreateUserId: {9}{11}- UpdateUserId: {10}{11}{13}", 
				this.TeacherId,
				this.SchoolId,
