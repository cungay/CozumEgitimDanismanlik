	...
	{		
		...
		public virtual System.Int32 Id
		{
			...
			set
			{
				...
				OnColumnChanging(ProvinceColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ProvinceColumn.Id, this.entityData.Id);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"Id", "RowNumber", "AdminId", "ObjectId", "ParentId", "PlateCode", "AreaId", "PhoneCode", "ProvinceName", "Longitude", "Latitude", "Type", "CreateDate", "CreateTime", "UpdateDate", "UpdateTime"};
			}
		}
		#endregion 
...
/*
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{17}{16}- Id: {0}{16}- RowNumber: {1}{16}- AdminId: {2}{16}- ObjectId: {3}{16}- ParentId: {4}{16}- PlateCode: {5}{16}- AreaId: {6}{16}- PhoneCode: {7}{16}- ProvinceName: {8}{16}- Longitude: {9}{16}- Latitude: {10}{16}- Type: {11}{16}- CreateDate: {12}{16}- CreateTime: {13}{16}- UpdateDate: {14}{16}- UpdateTime: {15}{16}{18}", 
				this.Id,
				this.RowNumber,
				this.AdminId,
				this.ObjectId,
	...
	public class ProvinceKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the ProvinceKey class.
		/// </summary>
		public ProvinceKey(System.Int32 _ıd)
		{
			#region Init Properties
