	...
	{		
		...
		public virtual System.Int32 Id
		{
			...
			set
			{
				...
				OnColumnChanging(CalenderAgeColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CalenderAgeColumn.Id, this.entityData.Id);
...
/*
	...
	public class CalenderAgeKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the CalenderAgeKey class.
		/// </summary>
		public CalenderAgeKey(System.Int32 _ıd)
		{
			#region Init Properties
