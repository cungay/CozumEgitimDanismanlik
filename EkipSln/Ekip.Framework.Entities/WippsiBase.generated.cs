...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public WippsiBase(System.Int32? _generalRawScore, System.Int32? _generalStandartScore, System.Int32? _similarityRawScore, 
			System.Int32? _similarityStandartScore, System.Int32? _arithmeticRawScore, System.Int32? _arithmeticStandartScore, 
			System.Int32? _wordRawScore, System.Int32? _wordStandartScore, System.Int32? _understandingRawScore, System.Int32? _understandingStandartScore, 
			System.Int32? _sentencesRawScore, System.Int32? _sentencesStandartScore, System.Int32? _ımageDefineRawScore, 
			System.Int32? _ımageDefineStandartScore, System.Int32? _animalHomesRawScore, System.Int32? _animalHomesStandartScore, 
			System.Int32? _geometricShapeRawScore, System.Int32? _geometricShapeStandartScore, System.Int32? _blocksPatternRawScore, 
			System.Int32? _blocksPatternStandartScore, System.Int32? _animalHomesAgainRawScore, System.Int32? _animalHomesAgainStandartScore, 
			...
			System.Int32 _userId, System.Int32? _advisorId)
		{
			...
			newWippsi.UserId = _userId;
			newWippsi.AdvisorId = _advisorId;
			return newWippsi;
		}
		...
		public virtual System.Int32 UserId
		{
			...
			set
			{
				...
				OnColumnChanging(WippsiColumn.UserId, this.entityData.UserId);
				this.entityData.UserId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(WippsiColumn.UserId, this.entityData.UserId);
		...
		public virtual System.Int32? AdvisorId
		{
			...
			set
			{
				...
				OnColumnChanging(WippsiColumn.AdvisorId, this.entityData.AdvisorId);
				this.entityData.AdvisorId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(WippsiColumn.AdvisorId, this.entityData.AdvisorId);
		...
		///	which are related to this object through the relation FK_Seance_Wippsi
		/// </summary>	
		...
		public bool IsPropertyChanged(WippsiColumn column)
		{
			switch(column)
			{
					...
					case WippsiColumn.UserId:
					return entityData.UserId != _originalData.UserId;
					case WippsiColumn.AdvisorId:
...
/*
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{34}{33}- WippsiId: {0}{33}- GeneralRawScore: {1}{33}- GeneralStandartScore: {2}{33}- SimilarityRawScore: {3}{33}- SimilarityStandartScore: {4}{33}- ArithmeticRawScore: {5}{33}- ArithmeticStandartScore: {6}{33}- WordRawScore: {7}{33}- WordStandartScore: {8}{33}- UnderstandingRawScore: {9}{33}- UnderstandingStandartScore: {10}{33}- SentencesRawScore: {11}{33}- SentencesStandartScore: {12}{33}- ImageDefineRawScore: {13}{33}- ImageDefineStandartScore: {14}{33}- AnimalHomesRawScore: {15}{33}- AnimalHomesStandartScore: {16}{33}- GeometricShapeRawScore: {17}{33}- GeometricShapeStandartScore: {18}{33}- BlocksPatternRawScore: {19}{33}- BlocksPatternStandartScore: {20}{33}- AnimalHomesAgainRawScore: {21}{33}- AnimalHomesAgainStandartScore: {22}{33}- MazesRawScore: {23}{33}- MazesStandartScore: {24}{33}- TotalVerbalScore: {25}{33}- TotalPerformanceScore: {26}{33}- TotalScore: {27}{33}- TestDate: {28}{33}- CreateDate: {29}{33}- UpdateDate: {30}{33}- UserId: {31}{33}- AdvisorId: {32}{33}{35}", 
				this.WippsiId,
	...
	internal protected class WippsiEntityData : ICloneable, ICloneableEx
	{
		...
		private TList<Seance> _seanceWippsiId;
		
		/// <summary>
		///	Holds a collection of entity objects
		///	which are related to this object through the relation _seanceWippsiId
		/// </summary>
		[DataMember]
		public TList<Seance> SeanceCollection
		{
			get
			{
				if (_seanceWippsiId == null)
				{
				_seanceWippsiId = new TList<Seance>();
				}
	
				return _seanceWippsiId;
			}
			set { _seanceWippsiId = value; }
		}
	...
	public enum WippsiColumn : int
	{
		...
		GeometricShapeStandartScore = 19,
		/// <summary>
		/// BlocksPatternRawScore : 
		/// </summary>
		...
		AnimalHomesAgainStandartScore = 23,
		/// <summary>
		/// MazesRawScore : 
		/// </summary>
