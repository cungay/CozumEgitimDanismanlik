...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public SeanceBase(System.Int32 _clientId, System.Int32 _advisorId, System.DateTime? _seanceDate, 
			System.TimeSpan? _seanceTime, System.String _seanceNotes, System.Byte _seanceStatusId, System.Int32? _wippsiId, 
			System.Int32? _wiscrId, System.Boolean _active, System.Boolean _deleted, System.DateTime _createDate, 
			System.DateTime? _updateDate, System.Int32? _createdUserId, System.Int32? _updatedUserId)
		{
			this.entityData = new SeanceEntityData();
			this.backupData = null;
			...
			System.DateTime? _updateDate, System.Int32? _createdUserId, System.Int32? _updatedUserId)
		{
			...
			newSeance.SeanceNotes = _seanceNotes;
			newSeance.SeanceStatusId = _seanceStatusId;
			newSeance.WippsiId = _wippsiId;
			newSeance.WiscrId = _wiscrId;
		...
		/// <summary>
		/// 	Gets or sets the SeanceNotes property. 
		///		
		/// </summary>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.String SeanceNotes
		{
			get
			{
				return this.entityData.SeanceNotes; 
			}
			
			set
			{
				if (this.entityData.SeanceNotes == value)
					return;
				
                OnPropertyChanging("SeanceNotes");                    
				OnColumnChanging(SeanceColumn.SeanceNotes, this.entityData.SeanceNotes);
				this.entityData.SeanceNotes = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SeanceColumn.SeanceNotes, this.entityData.SeanceNotes);
				OnPropertyChanged("SeanceNotes");
			}
		}
		...
		public virtual System.Int32? WippsiId
		{
			...
			set
			{
				...
				OnColumnChanging(SeanceColumn.WippsiId, this.entityData.WippsiId);
				this.entityData.WippsiId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SeanceColumn.WippsiId, this.entityData.WippsiId);
		...
		public virtual System.Int32? WiscrId
		{
			...
			set
			{
				...
				OnColumnChanging(SeanceColumn.WiscrId, this.entityData.WiscrId);
				this.entityData.WiscrId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SeanceColumn.WiscrId, this.entityData.WiscrId);
		...
		/// <summary>
		/// Gets or sets the source <see cref="Wippsi"/>.
		/// </summary>
		/// <value>The source Wippsi for WippsiId.</value>
        [XmlIgnore()]
		[Browsable(false), System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual Wippsi WippsiIdSource
      	{
            get { return entityData.WippsiIdSource; }
            set { entityData.WippsiIdSource = value; }
      	}
		/// <summary>
		/// Gets or sets the source <see cref="Wiscr"/>.
		/// </summary>
		/// <value>The source Wiscr for WiscrId.</value>
        [XmlIgnore()]
		[Browsable(false), System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual Wiscr WiscrIdSource
      	{
            get { return entityData.WiscrIdSource; }
            set { entityData.WiscrIdSource = value; }
      	}
		#endregion
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"SeanceId", "ClientId", "AdvisorId", "SeanceDate", "SeanceTime", "SeanceNotes", "SeanceStatusId", "WippsiId", "WiscrId", "Active", "Deleted", "CreateDate", "UpdateDate", "CreatedUserId", "UpdatedUserId"};
			}
		}
		#endregion 
		...
		protected virtual Seance Copy(IDictionary existingCopies)
		{
			...
			copy.SuppressEntityEvents = true;
				...
				copy.SeanceNotes = this.SeanceNotes;
			...
			if (this.WippsiIdSource != null && existingCopies.Contains(this.WippsiIdSource))
				copy.WippsiIdSource = existingCopies[this.WippsiIdSource] as Wippsi;
			else
				copy.WippsiIdSource = MakeCopyOf(this.WippsiIdSource, existingCopies) as Wippsi;
			if (this.WiscrIdSource != null && existingCopies.Contains(this.WiscrIdSource))
				copy.WiscrIdSource = existingCopies[this.WiscrIdSource] as Wiscr;
			else
				copy.WiscrIdSource = MakeCopyOf(this.WiscrIdSource, existingCopies) as Wiscr;
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.SeanceNotes != _originalData.SeanceNotes;
		...
		public Seance GetOriginalEntity()
		{
			if (_originalData != null)
				...
				_originalData.SeanceNotes,
				_originalData.SeanceStatusId,
				_originalData.WippsiId,
				_originalData.WiscrId,
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.SeanceId.GetHashCode() ^ 
					...
					((this.SeanceNotes == null) ? string.Empty : this.SeanceNotes.ToString()).GetHashCode() ^ 
					this.SeanceStatusId.GetHashCode() ^ 
					((this.WippsiId == null) ? string.Empty : this.WippsiId.ToString()).GetHashCode() ^ 
					((this.WiscrId == null) ? string.Empty : this.WiscrId.ToString()).GetHashCode() ^ 
		...
		public static bool ValueEquals(SeanceBase Object1, SeanceBase Object2)
		{
			...
			if ( Object1.SeanceNotes != null && Object2.SeanceNotes != null )
			{
				if (Object1.SeanceNotes != Object2.SeanceNotes)
					equal = false;
			}
			else if (Object1.SeanceNotes == null ^ Object2.SeanceNotes == null )
			{
				equal = false;
			}
			if (Object1.SeanceStatusId != Object2.SeanceStatusId)
				equal = false;
			if ( Object1.WippsiId != null && Object2.WippsiId != null )
			{
				if (Object1.WippsiId != Object2.WippsiId)
					equal = false;
			}
			else if (Object1.WippsiId == null ^ Object2.WippsiId == null )
			{
				equal = false;
			}
			if ( Object1.WiscrId != null && Object2.WiscrId != null )
			{
				if (Object1.WiscrId != Object2.WiscrId)
					equal = false;
			}
			else if (Object1.WiscrId == null ^ Object2.WiscrId == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(Seance rhs, SeanceColumn which)
        {
            switch (which)
            {
            	...
            	case SeanceColumn.SeanceNotes:
            		return this.SeanceNotes.CompareTo(rhs.SeanceNotes);
            	...
            	case SeanceColumn.WippsiId:
            		return this.WippsiId.Value.CompareTo(rhs.WippsiId.Value);
            		
            		                 
            	
            	
            	case SeanceColumn.WiscrId:
            		return this.WiscrId.Value.CompareTo(rhs.WiscrId.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{16}{15}- SeanceId: {0}{15}- ClientId: {1}{15}- AdvisorId: {2}{15}- SeanceDate: {3}{15}- SeanceTime: {4}{15}- SeanceNotes: {5}{15}- SeanceStatusId: {6}{15}- WippsiId: {7}{15}- WiscrId: {8}{15}- Active: {9}{15}- Deleted: {10}{15}- CreateDate: {11}{15}- UpdateDate: {12}{15}- CreatedUserId: {13}{15}- UpdatedUserId: {14}{15}{17}", 
				this.SeanceId,
				this.ClientId,
				this.AdvisorId,
				(this.SeanceDate == null) ? string.Empty : this.SeanceDate.ToString(),
				(this.SeanceTime == null) ? string.Empty : this.SeanceTime.ToString(),
				(this.SeanceNotes == null) ? string.Empty : this.SeanceNotes.ToString(),
				this.SeanceStatusId,
				(this.WippsiId == null) ? string.Empty : this.WippsiId.ToString(),
				(this.WiscrId == null) ? string.Empty : this.WiscrId.ToString(),
				this.Active,
				this.Deleted,
				this.CreateDate,
	...
	internal protected class SeanceEntityData : ICloneable, ICloneableEx
	{
		...
		/// </summary>
		[DataMember]
		public System.String SeanceNotes = null;
		...
		/// </summary>
		[DataMember]
		public System.Int32? WippsiId = null;
		
		/// <summary>
		/// WiscrId : 
		/// </summary>
		[DataMember]
		public System.Int32? WiscrId = null;
		...
		private Wippsi _wippsiIdSource = null;
		...
		public virtual Wippsi WippsiIdSource
      	{
            get { return this._wippsiIdSource; }
            set { this._wippsiIdSource = value; }
      	}
		private Wiscr _wiscrIdSource = null;
		...
		public virtual Wiscr WiscrIdSource
      	{
            get { return this._wiscrIdSource; }
            set { this._wiscrIdSource = value; }
      	}
		#endregion
		...
		public Object Clone()
		{
			...
			_tmp.SeanceNotes = this.SeanceNotes;
			...
			if (this.WippsiIdSource != null)
				_tmp.WippsiIdSource = MakeCopyOf(this.WippsiIdSource) as Wippsi;
			if (this.WiscrIdSource != null)
				_tmp.WiscrIdSource = MakeCopyOf(this.WiscrIdSource) as Wiscr;
			#endregion
		...
		public object Clone(IDictionary existingCopies)
		{
			...
			if (this.WippsiIdSource != null && existingCopies.Contains(this.WippsiIdSource))
				_tmp.WippsiIdSource = existingCopies[this.WippsiIdSource] as Wippsi;
			else
				_tmp.WippsiIdSource = MakeCopyOf(this.WippsiIdSource, existingCopies) as Wippsi;
			if (this.WiscrIdSource != null && existingCopies.Contains(this.WiscrIdSource))
				_tmp.WiscrIdSource = existingCopies[this.WiscrIdSource] as Wiscr;
			else
				_tmp.WiscrIdSource = MakeCopyOf(this.WiscrIdSource, existingCopies) as Wiscr;
			#endregion
	...
	public enum SeanceColumn : int
	{
		...
		/// SeanceNotes : 
		/// </summary>
		[EnumTextValue("Seance Notes")]
		[ColumnEnum("SeanceNotes", typeof(System.String), System.Data.DbType.AnsiString, false, false, true)]
		SeanceNotes = 6,
		/// <summary>
		/// SeanceStatusId : 
		/// </summary>
		...
		[ColumnEnum("WippsiId", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		WippsiId = 8,
		/// <summary>
		/// WiscrId : 
		/// </summary>
		[EnumTextValue("Wiscr Id")]
		[ColumnEnum("WiscrId", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		WiscrId = 9,
		/// <summary>
		/// Active : 
		/// </summary>
