...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public SchoolBase(System.String _schoolName, System.Byte _ınstitutionTypeId, System.Byte _schoolTypeId, 
			System.Byte _classRoom, System.Int32? _provinceId, System.Int32? _townId, System.String _address, 
			System.String _phone, System.String _fax, System.String _webAddress, System.String _notes, System.DateTime _createOn, 
			System.DateTime? _updateOn, System.Int32 _createUserId, System.Int32? _updateUserId)
		{
			this.entityData = new SchoolEntityData();
			this.backupData = null;
			...
			System.DateTime? _updateOn, System.Int32 _createUserId, System.Int32? _updateUserId)
		{
			...
			newSchool.ClassRoom = _classRoom;
		...
		public virtual System.Byte ClassRoom
		{
			...
			set
			{
				...
				OnColumnChanging(SchoolColumn.ClassRoom, this.entityData.ClassRoom);
				this.entityData.ClassRoom = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SchoolColumn.ClassRoom, this.entityData.ClassRoom);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"SchoolId", "SchoolName", "InstitutionTypeId", "SchoolTypeId", "ClassRoom", "ProvinceId", "TownId", "Address", "Phone", "Fax", "WebAddress", "Notes", "CreateOn", "UpdateOn", "CreateUserId", "UpdateUserId"};
			}
		}
		#endregion 
...
/*
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{17}{16}- SchoolId: {0}{16}- SchoolName: {1}{16}- InstitutionTypeId: {2}{16}- SchoolTypeId: {3}{16}- ClassRoom: {4}{16}- ProvinceId: {5}{16}- TownId: {6}{16}- Address: {7}{16}- Phone: {8}{16}- Fax: {9}{16}- WebAddress: {10}{16}- Notes: {11}{16}- CreateOn: {12}{16}- UpdateOn: {13}{16}- CreateUserId: {14}{16}- UpdateUserId: {15}{16}{18}", 
				this.SchoolId,
				this.SchoolName,
	...
	internal protected class SchoolEntityData : ICloneable, ICloneableEx
	{
		...
		/// </summary>
		[DataMember]
		public System.Byte ClassRoom = (byte)0;
	...
	public enum SchoolColumn : int
	{
		...
		[ColumnEnum("ClassRoom", typeof(System.Byte), System.Data.DbType.Byte, false, false, false)]
		ClassRoom = 5,
		/// <summary>
		/// ProvinceId : 
		/// </summary>
