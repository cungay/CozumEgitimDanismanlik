...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public SchoolBase(System.String _schoolName, System.Byte _ınstitutionTypeId, System.Byte _schoolTypeId, 
			System.Int32? _provinceId, System.Int32? _townId, System.String _address, System.String _phone, System.String _fax, 
			System.String _webAddress, System.String _schoolNotes, System.DateTime _createOn, System.DateTime? _updateOn, 
			System.Int32 _createUserId, System.Int32? _updateUserId)
		{
			...
			this.InstitutionTypeId = _ınstitutionTypeId;
		...
		///<param name="_createUserId"></param>
		///<param name="_updateUserId"></param>
		public static School CreateSchool(System.String _schoolName, System.Byte _ınstitutionTypeId, System.Byte _schoolTypeId, 
			System.Int32? _provinceId, System.Int32? _townId, System.String _address, System.String _phone, System.String _fax, 
			System.String _webAddress, System.String _schoolNotes, System.DateTime _createOn, System.DateTime? _updateOn, 
			System.Int32 _createUserId, System.Int32? _updateUserId)
		{
			...
			newSchool.InstitutionTypeId = _ınstitutionTypeId;
			...
			newSchool.SchoolNotes = _schoolNotes;
			newSchool.CreateOn = _createOn;
			newSchool.UpdateOn = _updateOn;
		...
		/// <summary>
		/// 	Gets or sets the InstitutionTypeId property. 
		///		
		/// </summary>
		...
		public virtual System.Byte InstitutionTypeId
		{
			get
			{
				return this.entityData.InstitutionTypeId; 
			}
			
			set
			{
				if (this.entityData.InstitutionTypeId == value)
					return;
				
                OnPropertyChanging("InstitutionTypeId");                    
				OnColumnChanging(SchoolColumn.InstitutionTypeId, this.entityData.InstitutionTypeId);
				this.entityData.InstitutionTypeId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SchoolColumn.InstitutionTypeId, this.entityData.InstitutionTypeId);
				OnPropertyChanged("InstitutionTypeId");
			}
		}
		...
		/// <summary>
		/// 	Gets or sets the SchoolNotes property. 
		///		
		/// </summary>
		/// <value>This type is varchar.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.String SchoolNotes
		{
			get
			{
				return this.entityData.SchoolNotes; 
			}
			
			set
			{
				if (this.entityData.SchoolNotes == value)
					return;
				
                OnPropertyChanging("SchoolNotes");                    
				OnColumnChanging(SchoolColumn.SchoolNotes, this.entityData.SchoolNotes);
				this.entityData.SchoolNotes = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SchoolColumn.SchoolNotes, this.entityData.SchoolNotes);
				OnPropertyChanged("SchoolNotes");
			}
		}
		...
		public virtual System.DateTime CreateOn
		{
			...
			set
			{
				...
				OnColumnChanging(SchoolColumn.CreateOn, this.entityData.CreateOn);
				this.entityData.CreateOn = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SchoolColumn.CreateOn, this.entityData.CreateOn);
		...
		public virtual System.DateTime? UpdateOn
		{
			...
			set
			{
				...
				OnColumnChanging(SchoolColumn.UpdateOn, this.entityData.UpdateOn);
				this.entityData.UpdateOn = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SchoolColumn.UpdateOn, this.entityData.UpdateOn);
		...
		///	which are related to this object through the relation FK_ClientSchool_School
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"SchoolId", "SchoolName", "InstitutionTypeId", "SchoolTypeId", "ProvinceId", "TownId", "Address", "Phone", "Fax", "WebAddress", "SchoolNotes", "CreateOn", "UpdateOn", "CreateUserId", "UpdateUserId"};
			}
		}
		#endregion 
		...
		protected virtual School Copy(IDictionary existingCopies)
		{
			...
			copy.SuppressEntityEvents = true;
				...
				copy.InstitutionTypeId = this.InstitutionTypeId;
				...
				copy.SchoolNotes = this.SchoolNotes;
		...
		public bool IsPropertyChanged(SchoolColumn column)
		{
			switch(column)
			{
					...
					case SchoolColumn.InstitutionTypeId:
					return entityData.InstitutionTypeId != _originalData.InstitutionTypeId;
					...
					case SchoolColumn.SchoolNotes:
					return entityData.SchoolNotes != _originalData.SchoolNotes;
					case SchoolColumn.CreateOn:
					return entityData.CreateOn != _originalData.CreateOn;
					case SchoolColumn.UpdateOn:
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.InstitutionTypeId != _originalData.InstitutionTypeId;
			...
			result = result || entityData.SchoolNotes != _originalData.SchoolNotes;
		...
		public School GetOriginalEntity()
		{
			if (_originalData != null)
				...
				_originalData.InstitutionTypeId,
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.SchoolId.GetHashCode() ^ 
					...
					this.InstitutionTypeId.GetHashCode() ^ 
					...
					((this.SchoolNotes == null) ? string.Empty : this.SchoolNotes.ToString()).GetHashCode() ^ 
		...
		public static bool ValueEquals(SchoolBase Object1, SchoolBase Object2)
		{
			...
			if (Object1.SchoolName != Object2.SchoolName)
				equal = false;
			if (Object1.InstitutionTypeId != Object2.InstitutionTypeId)
				equal = false;
			...
			if ( Object1.SchoolNotes != null && Object2.SchoolNotes != null )
			{
				if (Object1.SchoolNotes != Object2.SchoolNotes)
					equal = false;
			}
			else if (Object1.SchoolNotes == null ^ Object2.SchoolNotes == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(School rhs, SchoolColumn which)
        {
            switch (which)
            {
            	...
            	case SchoolColumn.InstitutionTypeId:
            		return this.InstitutionTypeId.CompareTo(rhs.InstitutionTypeId);
            	...
            	case SchoolColumn.SchoolNotes:
            		return this.SchoolNotes.CompareTo(rhs.SchoolNotes);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{16}{15}- SchoolId: {0}{15}- SchoolName: {1}{15}- InstitutionTypeId: {2}{15}- SchoolTypeId: {3}{15}- ProvinceId: {4}{15}- TownId: {5}{15}- Address: {6}{15}- Phone: {7}{15}- Fax: {8}{15}- WebAddress: {9}{15}- SchoolNotes: {10}{15}- CreateOn: {11}{15}- UpdateOn: {12}{15}- CreateUserId: {13}{15}- UpdateUserId: {14}{15}{17}", 
				this.SchoolId,
				this.SchoolName,
				...
				(this.SchoolNotes == null) ? string.Empty : this.SchoolNotes.ToString(),
				this.CreateOn,
	...
	internal protected class SchoolEntityData : ICloneable, ICloneableEx
	{
		...
		/// </summary>
		[DataMember]
		public System.Byte InstitutionTypeId = (byte)0;
		...
		/// </summary>
		[DataMember]
		public System.String SchoolNotes = null;
		...
		private TList<ClientSchool> _clientSchoolSchoolId;
		...
		public TList<ClientSchool> ClientSchoolCollection
		{
			get
			{
				if (_clientSchoolSchoolId == null)
				{
				_clientSchoolSchoolId = new TList<ClientSchool>();
				}
	
				return _clientSchoolSchoolId;
			}
			set { _clientSchoolSchoolId = value; }
		}
		...
		public Object Clone()
		{
			...
			_tmp.InstitutionTypeId = this.InstitutionTypeId;
			...
			_tmp.SchoolNotes = this.SchoolNotes;
			...
			if (this._clientSchoolSchoolId != null)
	...
	public enum SchoolColumn : int
	{
		...
		/// InstitutionTypeId : 
		/// </summary>
		[EnumTextValue("Institution Type Id")]
		[ColumnEnum("InstitutionTypeId", typeof(System.Byte), System.Data.DbType.Byte, false, false, false)]
		InstitutionTypeId = 3,
		/// <summary>
		/// SchoolTypeId : 
		/// </summary>
		...
		/// SchoolNotes : 
		/// </summary>
		[EnumTextValue("School Notes")]
		[ColumnEnum("SchoolNotes", typeof(System.String), System.Data.DbType.AnsiString, false, false, true)]
		SchoolNotes = 11,
		/// <summary>
		/// CreateOn : 
		/// </summary>
