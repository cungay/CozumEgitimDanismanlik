...
{
    public partial class ClientInfo : BaseModule
    {
        #region Fields
        ...
        public ClientInfo()
        {
            ...
            cbGender.BindEnum(typeof(Gender));
            rgBlood.BindEnum(typeof(Blood));
            rgFamilyStatus.BindEnum(typeof(FamilyStatus));
            lkAddressTitle.BindEnum(typeof(AddressTitles), "Adres Başlığı", false);
            ...
            txtRef.EditValueChanged += Editor_ToUpper;
            txtClientNotes.EditValueChanged += Editor_ToUpper;
        ...
        private void DataBind(Client client)
        {
            ...
            if (client.MotherId.HasValue && client.MotherId.Value > 0)
                client.MotherIdSource = motherService.GetByMotherId(client.MotherId.Value);
            else
            ...
            if (client.FatherId.HasValue && client.FatherId.Value > 0)
                client.FatherIdSource = fatherService.GetByFatherId(client.FatherId.Value);
            else
