...
namespace Ekip.Framework.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.Client> entities)
		{
			...
			DataColumn col5 = dataTable.Columns.Add("Reference", typeof(System.String));
			col5.AllowDBNull = true;		
			DataColumn col6 = dataTable.Columns.Add("MotherId", typeof(System.Int32));
			col6.AllowDBNull = true;		
			DataColumn col7 = dataTable.Columns.Add("FatherId", typeof(System.Int32));
			col7.AllowDBNull = true;		
			DataColumn col8 = dataTable.Columns.Add("AddressId", typeof(System.Int32));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("IdCard", typeof(System.String));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("Gender", typeof(System.Byte));
			col10.AllowDBNull = false;		
			DataColumn col11 = dataTable.Columns.Add("Blood", typeof(System.Byte));
			col11.AllowDBNull = false;		
			DataColumn col12 = dataTable.Columns.Add("BirthDate", typeof(System.DateTime));
			col12.AllowDBNull = true;		
			DataColumn col13 = dataTable.Columns.Add("Age", typeof(System.Int32));
			col13.AllowDBNull = true;		
			DataColumn col14 = dataTable.Columns.Add("Pediatrician", typeof(System.String));
			col14.AllowDBNull = true;		
			DataColumn col15 = dataTable.Columns.Add("CountOfChild", typeof(System.Int32));
			col15.AllowDBNull = false;		
			DataColumn col16 = dataTable.Columns.Add("FamilyStatus", typeof(System.Byte));
			col16.AllowDBNull = false;		
			DataColumn col17 = dataTable.Columns.Add("Notes", typeof(System.String));
			col17.AllowDBNull = true;		
			DataColumn col18 = dataTable.Columns.Add("CreateOn", typeof(System.DateTime));
			col18.AllowDBNull = false;		
			DataColumn col19 = dataTable.Columns.Add("UpdateOn", typeof(System.DateTime));
			col19.AllowDBNull = true;		
			DataColumn col20 = dataTable.Columns.Add("UserId", typeof(System.Int32));
			...
			foreach(Ekip.Framework.Entities.Client entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["FirstContactDate"] = entity.FirstContactDate.HasValue ? (object) entity.FirstContactDate  : System.DBNull.Value;
					...
					row["MotherId"] = entity.MotherId.HasValue ? (object) entity.MotherId  : System.DBNull.Value;
							
				
					row["FatherId"] = entity.FatherId.HasValue ? (object) entity.FatherId  : System.DBNull.Value;
					...
					row["Age"] = entity.Age.HasValue ? (object) entity.Age  : System.DBNull.Value;
		...
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.Client entity)
		{
			...
			database.AddInParameter(commandWrapper, "@FirstContactDate", DbType.DateTime, (entity.FirstContactDate.HasValue ? (object) entity.FirstContactDate  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@MotherId", DbType.Int32, (entity.MotherId.HasValue ? (object) entity.MotherId  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@FatherId", DbType.Int32, (entity.FatherId.HasValue ? (object) entity.FatherId  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@Age", DbType.Int32, (entity.Age.HasValue ? (object) entity.Age  : System.DBNull.Value));
		...
		public override IDataReader FindByReason_FirstDate_BirthDate(TransactionManager transactionManager, int start, int pageLength , System.String seanceReasonIds, System.String firstContactYears, System.String birthDateYears)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader AdvisorReport(TransactionManager transactionManager, int start, int pageLength , System.String advisorIds)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
