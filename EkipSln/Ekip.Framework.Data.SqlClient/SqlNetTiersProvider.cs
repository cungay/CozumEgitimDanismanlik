...
namespace Ekip.Framework.Data.SqlClient
{
	...
	public sealed class SqlNetTiersProvider : Ekip.Framework.Data.Bases.NetTiersProvider
	{
		...
		/// <summary>
		/// Gets the current <see cref="SqlSessionProvider"/>.
		/// </summary>
		/// <value></value>
		...
		private SqlClientDocProvider innerSqlClientDocProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="ClientDoc"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override ClientDocProviderBase ClientDocProvider
		{
			get
			{
				if (innerSqlClientDocProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlClientDocProvider == null)
						{
							this.innerSqlClientDocProvider = new SqlClientDocProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlClientDocProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlClientDocProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlClientDocProvider SqlClientDocProvider
		{
			get {return ClientDocProvider as SqlClientDocProvider;}
		}
		...
		private SqlClientSchoolProvider innerSqlClientSchoolProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="ClientSchool"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override ClientSchoolProviderBase ClientSchoolProvider
		{
			get
			{
				if (innerSqlClientSchoolProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlClientSchoolProvider == null)
						{
							this.innerSqlClientSchoolProvider = new SqlClientSchoolProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlClientSchoolProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlClientSchoolProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlClientSchoolProvider SqlClientSchoolProvider
		{
			get {return ClientSchoolProvider as SqlClientSchoolProvider;}
		}
		...
		private SqlClientViewProvider innerSqlClientViewProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="ClientView"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override ClientViewProviderBase ClientViewProvider
		{
			get
			{
				if (innerSqlClientViewProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlClientViewProvider == null)
						{
							this.innerSqlClientViewProvider = new SqlClientViewProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlClientViewProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlClientViewProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlClientViewProvider SqlClientViewProvider
		{
			get {return ClientViewProvider as SqlClientViewProvider;}
		}
		...
		private SqlWippsiViewProvider innerSqlWippsiViewProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="WippsiView"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override WippsiViewProviderBase WippsiViewProvider
		{
			get
			{
				if (innerSqlWippsiViewProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlWippsiViewProvider == null)
						{
							this.innerSqlWippsiViewProvider = new SqlWippsiViewProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlWippsiViewProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlWippsiViewProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlWippsiViewProvider SqlWippsiViewProvider
		{
			get {return WippsiViewProvider as SqlWippsiViewProvider;}
		}
		...
		private SqlWiscrViewProvider innerSqlWiscrViewProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="WiscrView"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override WiscrViewProviderBase WiscrViewProvider
		{
			get
			{
				if (innerSqlWiscrViewProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlWiscrViewProvider == null)
						{
							this.innerSqlWiscrViewProvider = new SqlWiscrViewProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlWiscrViewProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlWiscrViewProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlWiscrViewProvider SqlWiscrViewProvider
		{
			get {return WiscrViewProvider as SqlWiscrViewProvider;}
		}
