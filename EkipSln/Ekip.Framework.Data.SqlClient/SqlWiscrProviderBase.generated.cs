...
namespace Ekip.Framework.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@CubesPatternRawScore", DbType.StringFixedLength, DBNull.Value);
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.Wiscr> entities)
		{
			...
			DataColumn col9 = dataTable.Columns.Add("JudgingRawScore", typeof(System.Int32));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("JudgingStandartScore", typeof(System.Int32));
			col10.AllowDBNull = true;		
			DataColumn col11 = dataTable.Columns.Add("SetOfNumbersRawScore", typeof(System.Int32));
			col11.AllowDBNull = true;		
			DataColumn col12 = dataTable.Columns.Add("SetOfNumbersStandartScore", typeof(System.Int32));
			...
			DataColumn col15 = dataTable.Columns.Add("ImageEditingRawScore", typeof(System.Int32));
			col15.AllowDBNull = true;		
			DataColumn col16 = dataTable.Columns.Add("ImageEditingStandartScore", typeof(System.Int32));
			col16.AllowDBNull = true;		
			DataColumn col17 = dataTable.Columns.Add("CubesPatternRawScore", typeof(System.String));
			col17.AllowDBNull = true;		
			DataColumn col18 = dataTable.Columns.Add("CubesPatternStandartScore", typeof(System.Int32));
			col18.AllowDBNull = true;		
			DataColumn col19 = dataTable.Columns.Add("PartsMergeRawScore", typeof(System.Int32));
			col19.AllowDBNull = true;		
			DataColumn col20 = dataTable.Columns.Add("PartsMergeStandartScore", typeof(System.Int32));
			col20.AllowDBNull = true;		
			DataColumn col21 = dataTable.Columns.Add("PasswordRawScore", typeof(System.Int32));
			col21.AllowDBNull = true;		
			DataColumn col22 = dataTable.Columns.Add("PasswordStandartScore", typeof(System.Int32));
			...
			foreach(Ekip.Framework.Entities.Wiscr entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["CubesPatternRawScore"] = entity.CubesPatternRawScore;
		...
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.Wiscr entity)
		{
            ...
            database.AddInParameter(commandWrapper, "@CubesPatternRawScore", DbType.StringFixedLength, entity.CubesPatternRawScore );
