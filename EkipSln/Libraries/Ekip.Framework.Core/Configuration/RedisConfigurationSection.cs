...
namespace Ekip.Framework.Core.Configuration
{
    public class RedisConfigurationSection : ConfigurationSection
    {
        ...
        public string Host
        {
            get
            {
                return this[HostAttributeName].ToString();
            }
        }
        ...
        public int Port
        {
            get
            {
                return (int)this[PortAttributeName];
            }
        }
        ...
        public string Password
        {
            get
            {
                return this[PasswordAttributeName].ToString();
            }
        }
        ...
        public long DatabaseID
        {
            get
            {
                return (long)this[DatabaseIDAttributeName];
            }
        }
