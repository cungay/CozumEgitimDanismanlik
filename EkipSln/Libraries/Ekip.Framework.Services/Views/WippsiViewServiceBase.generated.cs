...
{		
	...
	public partial class WippsiViewServiceBase : ServiceViewBase<WippsiView>
	{
		...
		public virtual void GetByClientID(System.Int32? clientId)
		{
			 GetByClientID( clientId, 0, defaultMaxRecords );
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual void GetByClientID(System.Int32? clientId, int start, int pageLength)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.WippsiViewProvider.GetByClientID(transactionManager, start, pageLength , clientId);
