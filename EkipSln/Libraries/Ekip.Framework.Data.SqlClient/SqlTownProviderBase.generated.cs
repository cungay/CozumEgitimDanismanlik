...
namespace Ekip.Framework.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _townId)
		{
			...
			database.AddInParameter(commandWrapper, "@TownId", DbType.Int32, _townId);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Ekip.Framework.Entities.Town GetByTownId(TransactionManager transactionManager, System.Int32 _townId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Town_GetByTownId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByTownId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByTownId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.Town> entities)
		{
			...
			DataColumn col0 = dataTable.Columns.Add("TownId", typeof(System.Int32));
			...
			DataColumn col14 = dataTable.Columns.Add("CreateUserId", typeof(System.Int32));
			col14.AllowDBNull = false;		
			DataColumn col15 = dataTable.Columns.Add("UpdateUserId", typeof(System.Int32));
			col15.AllowDBNull = true;		
			DataColumn col16 = dataTable.Columns.Add("Active", typeof(System.Boolean));
			col16.AllowDBNull = false;		
			DataColumn col17 = dataTable.Columns.Add("Deleted", typeof(System.Boolean));
		...
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.Town entity)
		{
			...
			database.AddOutParameter(commandWrapper, "@TownId", DbType.Int32, 4);
			...
			object _townId = database.GetParameterValue(commandWrapper, "@TownId");
			entity.TownId = (System.Int32)_townId;
		...
		public override bool Update(TransactionManager transactionManager, Ekip.Framework.Entities.Town entity)
		{
            ...
            database.AddInParameter(commandWrapper, "@TownId", DbType.Int32, entity.TownId );
            database.AddInParameter(commandWrapper, "@RowNumber", DbType.Int32, entity.RowNumber );
            database.AddInParameter(commandWrapper, "@AdminId", DbType.Int64, entity.AdminId );
            database.AddInParameter(commandWrapper, "@ObjectId", DbType.Int64, entity.ObjectId );
            database.AddInParameter(commandWrapper, "@ParentId", DbType.Int64, entity.ParentId );
