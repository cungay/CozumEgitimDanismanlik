...
namespace Ekip.Framework.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.Client> entities)
		{
			...
			foreach(Ekip.Framework.Entities.Client entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["Blood"] = entity.Blood.HasValue ? (object) entity.Blood  : System.DBNull.Value;
					...
					row["FamilyStatus"] = entity.FamilyStatus.HasValue ? (object) entity.FamilyStatus  : System.DBNull.Value;
		...
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.Client entity)
		{
			...
			database.AddInParameter(commandWrapper, "@Gender", DbType.Byte, (entity.Gender.HasValue ? (object) entity.Gender  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@Blood", DbType.Byte, (entity.Blood.HasValue ? (object) entity.Blood  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@FamilyStatus", DbType.Byte, (entity.FamilyStatus.HasValue ? (object) entity.FamilyStatus  : System.DBNull.Value));
