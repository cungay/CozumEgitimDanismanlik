...
namespace Ekip.Framework.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@CalenderAgeId", DbType.Byte, DBNull.Value);
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.Client> entities)
		{
			...
			DataColumn col5 = dataTable.Columns.Add("CalenderAgeId", typeof(System.Byte));
			col5.AllowDBNull = true;		
			DataColumn col6 = dataTable.Columns.Add("FullName", typeof(System.String));
			col6.AllowDBNull = false;		
			DataColumn col7 = dataTable.Columns.Add("MiddleName", typeof(System.String));
			col7.AllowDBNull = true;		
			DataColumn col8 = dataTable.Columns.Add("Reference", typeof(System.String));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("MotherId", typeof(System.Int32));
			col9.AllowDBNull = false;		
			DataColumn col10 = dataTable.Columns.Add("FatherId", typeof(System.Int32));
			col10.AllowDBNull = false;		
			DataColumn col11 = dataTable.Columns.Add("AddressId", typeof(System.Int32));
			col11.AllowDBNull = true;		
			DataColumn col12 = dataTable.Columns.Add("IdCard", typeof(System.String));
			col12.AllowDBNull = true;		
			DataColumn col13 = dataTable.Columns.Add("Gender", typeof(System.Byte));
			col13.AllowDBNull = false;		
			DataColumn col14 = dataTable.Columns.Add("Blood", typeof(System.Byte));
			col14.AllowDBNull = false;		
			DataColumn col15 = dataTable.Columns.Add("Pediatrician", typeof(System.String));
			col15.AllowDBNull = true;		
			DataColumn col16 = dataTable.Columns.Add("CountOfChild", typeof(System.Int32));
			col16.AllowDBNull = false;		
			DataColumn col17 = dataTable.Columns.Add("FamilyStatus", typeof(System.Byte));
			...
			DataColumn col20 = dataTable.Columns.Add("UpdateDate", typeof(System.DateTime));
			col20.AllowDBNull = true;		
			DataColumn col21 = dataTable.Columns.Add("CreateUserId", typeof(System.Int32));
			col21.AllowDBNull = false;		
			DataColumn col22 = dataTable.Columns.Add("UpdateUserId", typeof(System.Int32));
			col22.AllowDBNull = true;		
			DataColumn col23 = dataTable.Columns.Add("Active", typeof(System.Boolean));
			col23.AllowDBNull = false;		
			DataColumn col24 = dataTable.Columns.Add("Deleted", typeof(System.Boolean));
			...
			foreach(Ekip.Framework.Entities.Client entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["CalenderAgeId"] = entity.CalenderAgeId.HasValue ? (object) entity.CalenderAgeId  : System.DBNull.Value;
		...
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.Client entity)
		{
			...
			database.AddInParameter(commandWrapper, "@CalenderAgeId", DbType.Byte, (entity.CalenderAgeId.HasValue ? (object) entity.CalenderAgeId  : System.DBNull.Value));
