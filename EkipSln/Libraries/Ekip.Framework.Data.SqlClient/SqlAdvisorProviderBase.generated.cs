...
/*
	...
	Important: Do not modify this file. Edit the file SqlAdvisorProvider.cs instead.
*/
...
namespace Ekip.Framework.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlAdvisorProviderBase : AdvisorProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlAdvisorProviderBase"/> instance.
		/// </summary>
		public SqlAdvisorProviderBase()
		{
		}
	...
	public SqlAdvisorProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _advisorId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Advisor_Delete", _useStoredProcedure);
			database.AddInParameter(commandWrapper, "@AdvisorId", DbType.Int32, _advisorId);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Advisor)
					,_advisorId);
		...
		public override TList<Advisor> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<Advisor>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Advisor_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@Deleted", DbType.Boolean, DBNull.Value);
			...
			//Create Collection
			TList<Advisor> rows = new TList<Advisor>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Advisor objects.</returns>
		public override TList<Advisor> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Advisor_Find_Dynamic", typeof(AdvisorColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Advisor> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Advisor_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Advisor objects.</returns>
		public override TList<Advisor> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Advisor_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Ekip.Framework.Entities.Advisor GetByAdvisorId(TransactionManager transactionManager, System.Int32 _advisorId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Advisor_GetByAdvisorId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@AdvisorId", DbType.Int32, _advisorId);
			
			IDataReader reader = null;
			TList<Advisor> tmp = new TList<Advisor>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByAdvisorId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByAdvisorId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.Advisor> entities)
		{
			...
			bulkCopy.DestinationTableName = "Advisor";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("AdvisorId", typeof(System.Int32));
			...
			foreach(Ekip.Framework.Entities.Advisor entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["TitleId"] = entity.TitleId.HasValue ? (object) entity.TitleId  : System.DBNull.Value;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.Advisor entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Advisor_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@AdvisorId", DbType.Int32, 4);
			database.AddInParameter(commandWrapper, "@TitleId", DbType.Byte, (entity.TitleId.HasValue ? (object) entity.TitleId  : System.DBNull.Value));
			...
			object _advisorId = database.GetParameterValue(commandWrapper, "@AdvisorId");
			entity.AdvisorId = (System.Int32)_advisorId;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, Ekip.Framework.Entities.Advisor entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Advisor_Update", _useStoredProcedure);
