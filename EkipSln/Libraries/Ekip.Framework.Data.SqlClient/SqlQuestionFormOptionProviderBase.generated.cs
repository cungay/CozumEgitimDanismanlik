...
namespace Ekip.Framework.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _optionId)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_QuestionFormOption_Delete", _useStoredProcedure);
		...
		public override TList<QuestionFormOption> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_QuestionFormOption_Find", _useStoredProcedure);
		...
		public override TList<QuestionFormOption> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_QuestionFormOption_Find_Dynamic", typeof(QuestionFormOptionColumn), filter, orderBy, start, pageLength);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_QuestionFormOption_Get_List", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_QuestionFormOption_GetPaged", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_QuestionFormOption_GetByQuestionId", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_QuestionFormOption_GetByOptionId", _useStoredProcedure);
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.QuestionFormOption> entities)
		{
			...
			bulkCopy.DestinationTableName = "QuestionFormOption";
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_QuestionFormOption_Insert", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_QuestionFormOption_Update", _useStoredProcedure);
