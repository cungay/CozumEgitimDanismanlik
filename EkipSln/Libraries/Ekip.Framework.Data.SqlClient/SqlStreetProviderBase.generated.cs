...
namespace Ekip.Framework.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _streetId)
		{
			...
			database.AddInParameter(commandWrapper, "@StreetId", DbType.Int32, _streetId);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Ekip.Framework.Entities.Street GetByStreetId(TransactionManager transactionManager, System.Int32 _streetId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Street_GetByStreetId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByStreetId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByStreetId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.Street> entities)
		{
			...
			DataColumn col0 = dataTable.Columns.Add("StreetId", typeof(System.Int32));
		...
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.Street entity)
		{
			...
			database.AddOutParameter(commandWrapper, "@StreetId", DbType.Int32, 4);
			...
			object _streetId = database.GetParameterValue(commandWrapper, "@StreetId");
			entity.StreetId = (System.Int32)_streetId;
		...
		public override bool Update(TransactionManager transactionManager, Ekip.Framework.Entities.Street entity)
		{
            ...
            database.AddInParameter(commandWrapper, "@StreetId", DbType.Int32, entity.StreetId );
            database.AddInParameter(commandWrapper, "@AdminId", DbType.Int64, entity.AdminId );
            database.AddInParameter(commandWrapper, "@ObjectId", DbType.Int64, entity.ObjectId );
            database.AddInParameter(commandWrapper, "@RowNumber", DbType.Int32, entity.RowNumber );
            database.AddInParameter(commandWrapper, "@NeighborhoodId", DbType.Int32, entity.NeighborhoodId );
