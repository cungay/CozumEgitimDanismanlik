...
/*
	...
	Important: Do not modify this file. Edit the file SqlClientMotherProvider.cs instead.
*/
...
namespace Ekip.Framework.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlClientMotherProviderBase : ClientMotherProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlClientMotherProviderBase"/> instance.
		/// </summary>
		public SqlClientMotherProviderBase()
		{
		}
	...
	public SqlClientMotherProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _motherId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ClientMother_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(ClientMother)
					,_motherId);
		...
		public override TList<ClientMother> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<ClientMother>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ClientMother_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@OtherPhone", DbType.AnsiString, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@MotherStatusId", DbType.Byte, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Deleted", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("otherphone ") || clause.Trim().StartsWith("otherphone="))
				{
					database.SetParameterValue(commandWrapper, "@OtherPhone", 
				...
				if (clause.Trim().StartsWith("motherstatusıd ") || clause.Trim().StartsWith("motherstatusıd="))
				{
					database.SetParameterValue(commandWrapper, "@MotherStatusId", 
			...
			//Create Collection
			TList<ClientMother> rows = new TList<ClientMother>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.ClientMother objects.</returns>
		public override TList<ClientMother> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ClientMother_Find_Dynamic", typeof(ClientMotherColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ClientMother> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ClientMother_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.ClientMother objects.</returns>
		public override TList<ClientMother> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ClientMother_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Ekip.Framework.Entities.ClientMother GetByMotherId(TransactionManager transactionManager, System.Int32 _motherId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ClientMother_GetByMotherId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@MotherId", DbType.Int32, _motherId);
			
			IDataReader reader = null;
			TList<ClientMother> tmp = new TList<ClientMother>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByMotherId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByMotherId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.ClientMother> entities)
		{
			...
			bulkCopy.DestinationTableName = "ClientMother";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("MotherId", typeof(System.Int32));
			...
			DataColumn col8 = dataTable.Columns.Add("OtherPhone", typeof(System.String));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("JobId", typeof(System.Int32));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("Notes", typeof(System.String));
			col10.AllowDBNull = true;		
			DataColumn col11 = dataTable.Columns.Add("MotherStatusId", typeof(System.Byte));
			...
			bulkCopy.ColumnMappings.Add("OtherPhone", "OtherPhone");
			bulkCopy.ColumnMappings.Add("JobId", "JobId");
			bulkCopy.ColumnMappings.Add("Notes", "Notes");
			bulkCopy.ColumnMappings.Add("MotherStatusId", "MotherStatusId");
			...
			foreach(Ekip.Framework.Entities.ClientMother entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["OtherPhone"] = entity.OtherPhone;
					...
					row["MotherStatusId"] = entity.MotherStatusId;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.ClientMother entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ClientMother_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@MotherId", DbType.Int32, 4);
            ...
            database.AddInParameter(commandWrapper, "@OtherPhone", DbType.AnsiString, entity.OtherPhone );
            ...
            database.AddInParameter(commandWrapper, "@MotherStatusId", DbType.Byte, entity.MotherStatusId );
			...
			object _motherId = database.GetParameterValue(commandWrapper, "@MotherId");
			entity.MotherId = (System.Int32)_motherId;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, Ekip.Framework.Entities.ClientMother entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ClientMother_Update", _useStoredProcedure);
