...
/*
	...
	Important: Do not modify this file. Edit the file SqlObservationFormGroupProvider.cs instead.
*/
...
namespace Ekip.Framework.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlObservationFormGroupProviderBase : ObservationFormGroupProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlObservationFormGroupProviderBase"/> instance.
		/// </summary>
		public SqlObservationFormGroupProviderBase()
		{
		}
	...
	public SqlObservationFormGroupProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _groupId)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ObservationForm_Group_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(ObservationFormGroup)
					,_groupId);
		...
		public override TList<ObservationFormGroup> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<ObservationFormGroup>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ObservationForm_Group_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@GroupName", DbType.AnsiString, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Deleted", DbType.Boolean, DBNull.Value);
			...
			//Create Collection
			TList<ObservationFormGroup> rows = new TList<ObservationFormGroup>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.ObservationFormGroup objects.</returns>
		public override TList<ObservationFormGroup> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ObservationForm_Group_Find_Dynamic", typeof(ObservationFormGroupColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ObservationFormGroup> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ObservationForm_Group_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.ObservationFormGroup objects.</returns>
		public override TList<ObservationFormGroup> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ObservationForm_Group_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Ekip.Framework.Entities.ObservationFormGroup GetByGroupId(TransactionManager transactionManager, System.Int32 _groupId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ObservationForm_Group_GetByGroupId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@GroupId", DbType.Int32, _groupId);
			
			IDataReader reader = null;
			TList<ObservationFormGroup> tmp = new TList<ObservationFormGroup>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.ObservationFormGroup> entities)
		{
			...
			bulkCopy.DestinationTableName = "ObservationForm_Group";
			...
			DataColumn col2 = dataTable.Columns.Add("LineNumber", typeof(System.Int32));
			...
			foreach(Ekip.Framework.Entities.ObservationFormGroup entity in entities)
			{
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.ObservationFormGroup entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ObservationForm_Group_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@GroupId", DbType.Int32, 4);
            database.AddInParameter(commandWrapper, "@GroupName", DbType.AnsiString, entity.GroupName );
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, Ekip.Framework.Entities.ObservationFormGroup entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_ObservationForm_Group_Update", _useStoredProcedure);
