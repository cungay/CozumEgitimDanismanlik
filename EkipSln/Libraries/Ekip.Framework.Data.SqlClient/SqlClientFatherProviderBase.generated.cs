...
namespace Ekip.Framework.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@FatherStatusId", DbType.Byte, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Deleted", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("fatherstatusıd ") || clause.Trim().StartsWith("fatherstatusıd="))
				{
					database.SetParameterValue(commandWrapper, "@FatherStatusId", 
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.ClientFather> entities)
		{
			...
			DataColumn col11 = dataTable.Columns.Add("FatherStatusId", typeof(System.Byte));
			...
			bulkCopy.ColumnMappings.Add("FatherStatusId", "FatherStatusId");
			...
			foreach(Ekip.Framework.Entities.ClientFather entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["FatherStatusId"] = entity.FatherStatusId;
		...
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.ClientFather entity)
		{
            ...
            database.AddInParameter(commandWrapper, "@FatherStatusId", DbType.Byte, entity.FatherStatusId );
