...
/*
	...
	Important: Do not modify this file. Edit the file SqlNeighborhoodProvider.cs instead.
*/
...
namespace Ekip.Framework.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlNeighborhoodProviderBase : NeighborhoodProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlNeighborhoodProviderBase"/> instance.
		/// </summary>
		public SqlNeighborhoodProviderBase()
		{
		}
	...
	public SqlNeighborhoodProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _neighborhoodId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Neighborhood_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Neighborhood)
					,_neighborhoodId);
		...
		public override TList<Neighborhood> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<Neighborhood>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Neighborhood_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@NeighborhoodName", DbType.String, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Deleted", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("neighborhoodname ") || clause.Trim().StartsWith("neighborhoodname="))
				{
					database.SetParameterValue(commandWrapper, "@NeighborhoodName", 
			...
			//Create Collection
			TList<Neighborhood> rows = new TList<Neighborhood>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Neighborhood objects.</returns>
		public override TList<Neighborhood> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Neighborhood_Find_Dynamic", typeof(NeighborhoodColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Neighborhood> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Neighborhood_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Neighborhood objects.</returns>
		public override TList<Neighborhood> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Neighborhood_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Neighborhood> GetByTownId(TransactionManager transactionManager, System.Int32 _townId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Neighborhood_GetByTownId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@TownId", DbType.Int32, _townId);
			
			IDataReader reader = null;
			TList<Neighborhood> tmp = new TList<Neighborhood>();
			try
			{
				//Provider Data Requesting Command Event
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Ekip.Framework.Entities.Neighborhood GetByNeighborhoodId(TransactionManager transactionManager, System.Int32 _neighborhoodId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Neighborhood_GetByNeighborhoodId", _useStoredProcedure);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Ekip.Framework.Entities.Neighborhood> entities)
		{
			...
			bulkCopy.DestinationTableName = "Neighborhood";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("NeighborhoodId", typeof(System.Int32));
			...
			DataColumn col3 = dataTable.Columns.Add("ParentId", typeof(System.Int64));
			col3.AllowDBNull = false;		
			DataColumn col4 = dataTable.Columns.Add("RowNumber", typeof(System.Int32));
			col4.AllowDBNull = false;		
			DataColumn col5 = dataTable.Columns.Add("TownId", typeof(System.Int32));
			col5.AllowDBNull = false;		
			DataColumn col6 = dataTable.Columns.Add("NeighborhoodName", typeof(System.String));
			...
			bulkCopy.ColumnMappings.Add("NeighborhoodName", "NeighborhoodName");
			...
			foreach(Ekip.Framework.Entities.Neighborhood entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["NeighborhoodName"] = entity.NeighborhoodName;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, Ekip.Framework.Entities.Neighborhood entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Neighborhood_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@NeighborhoodId", DbType.Int32, 4);
            ...
            database.AddInParameter(commandWrapper, "@NeighborhoodName", DbType.String, entity.NeighborhoodName );
			...
			object _neighborhoodId = database.GetParameterValue(commandWrapper, "@NeighborhoodId");
			entity.NeighborhoodId = (System.Int32)_neighborhoodId;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, Ekip.Framework.Entities.Neighborhood entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_Neighborhood_Update", _useStoredProcedure);
