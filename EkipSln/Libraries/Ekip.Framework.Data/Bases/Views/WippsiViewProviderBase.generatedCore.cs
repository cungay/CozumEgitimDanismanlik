...
{	
	...
	public abstract class WippsiViewProviderBaseCore : EntityViewProviderBase<WippsiView>
	{
		...
		public void GetByClientID(System.Int32? clientId)
		{
			 GetByClientID(null, 0, int.MaxValue , clientId);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetByClientID(int start, int pageLength, System.Int32? clientId)
		{
			 GetByClientID(null, start, pageLength , clientId);
		}
		...
		/// <param name="clientId"> A <c>System.Int32?</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetByClientID(TransactionManager transactionManager, System.Int32? clientId)
		{
			 GetByClientID(transactionManager, 0, int.MaxValue , clientId);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void GetByClientID(TransactionManager transactionManager, int start, int pageLength, System.Int32? clientId);
