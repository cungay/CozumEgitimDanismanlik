	...
	public abstract class ProvinceViewProviderBaseCore : EntityViewProviderBase<ProvinceView>
	{
		...
		protected static VList&lt;ProvinceView&gt; Fill(DataTable dataTable, VList<ProvinceView> rows, int start, int pagelen)
		{
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					c.CreateUserId = (Convert.IsDBNull(row["CreateUserId"]))?(int)0:(System.Int32)row["CreateUserId"];
					...
					c.Deleted = (Convert.IsDBNull(row["Deleted"]))?false:(System.Boolean)row["Deleted"];
		...
		*/	
		...
		protected VList<ProvinceView> Fill(IDataReader reader, VList<ProvinceView> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.CreateUserId = (System.Int32)reader[((int)ProvinceViewColumn.CreateUserId)];
					//entity.CreateUserId = (Convert.IsDBNull(reader["CreateUserId"]))?(int)0:(System.Int32)reader["CreateUserId"];
					entity.UpdateUserId = (reader.IsDBNull(((int)ProvinceViewColumn.UpdateUserId)))?null:(System.Int32?)reader[((int)ProvinceViewColumn.UpdateUserId)];
					//entity.UpdateUserId = (Convert.IsDBNull(reader["UpdateUserId"]))?(int)0:(System.Int32?)reader["UpdateUserId"];
					entity.Active = (System.Boolean)reader[((int)ProvinceViewColumn.Active)];
					//entity.Active = (Convert.IsDBNull(reader["Active"]))?false:(System.Boolean)reader["Active"];
					entity.Deleted = (System.Boolean)reader[((int)ProvinceViewColumn.Deleted)];
					//entity.Deleted = (Convert.IsDBNull(reader["Deleted"]))?false:(System.Boolean)reader["Deleted"];
		...
		protected static void RefreshEntity(DataSet dataSet, ProvinceView entity)
		{
			...
			entity.CreateUserId = (Convert.IsDBNull(dataRow["CreateUserId"]))?(int)0:(System.Int32)dataRow["CreateUserId"];
			...
			entity.Deleted = (Convert.IsDBNull(dataRow["Deleted"]))?false:(System.Boolean)dataRow["Deleted"];
