...
{	
	...
	{		
		...
		public static TList<ClientAddress> Fill(IDataReader reader, TList<ClientAddress> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.CreateDate = (System.DateTime)reader[((int)ClientAddressColumn.CreateDate - 1)];
					c.UpdateDate = (reader.IsDBNull(((int)ClientAddressColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)ClientAddressColumn.UpdateDate - 1)];
					c.CreateUserId = (System.Int32)reader[((int)ClientAddressColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)ClientAddressColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ClientAddressColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)ClientAddressColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)ClientAddressColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.ClientAddress entity)
		{
			...
			entity.CreateDate = (System.DateTime)reader[((int)ClientAddressColumn.CreateDate - 1)];
			entity.UpdateDate = (reader.IsDBNull(((int)ClientAddressColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)ClientAddressColumn.UpdateDate - 1)];
			entity.CreateUserId = (System.Int32)reader[((int)ClientAddressColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)ClientAddressColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ClientAddressColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)ClientAddressColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)ClientAddressColumn.Deleted - 1)];
