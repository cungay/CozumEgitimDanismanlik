...
{	
	...
	{		
		...
		public static TList<ClientMother> Fill(IDataReader reader, TList<ClientMother> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.UpdateUserId = (reader.IsDBNull(((int)ClientMotherColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ClientMotherColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)ClientMotherColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)ClientMotherColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.ClientMother entity)
		{
			...
			entity.UpdateUserId = (reader.IsDBNull(((int)ClientMotherColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ClientMotherColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)ClientMotherColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)ClientMotherColumn.Deleted - 1)];
