...
{	
	...
	{		
		...
		public static TList<Wiscr> Fill(IDataReader reader, TList<Wiscr> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.SeanceId = (reader.IsDBNull(((int)WiscrColumn.SeanceId - 1)))?null:(System.Int32?)reader[((int)WiscrColumn.SeanceId - 1)];
					...
					c.CubesPatternRawScore = (reader.IsDBNull(((int)WiscrColumn.CubesPatternRawScore - 1)))?null:(System.Int32?)reader[((int)WiscrColumn.CubesPatternRawScore - 1)];
					...
					c.Notes = (reader.IsDBNull(((int)WiscrColumn.Notes - 1)))?null:(System.String)reader[((int)WiscrColumn.Notes - 1)];
					...
					c.CreateUserId = (System.Int32)reader[((int)WiscrColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)WiscrColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)WiscrColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)WiscrColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)WiscrColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Wiscr entity)
		{
			...
			entity.SeanceId = (reader.IsDBNull(((int)WiscrColumn.SeanceId - 1)))?null:(System.Int32?)reader[((int)WiscrColumn.SeanceId - 1)];
			...
			entity.CubesPatternRawScore = (reader.IsDBNull(((int)WiscrColumn.CubesPatternRawScore - 1)))?null:(System.Int32?)reader[((int)WiscrColumn.CubesPatternRawScore - 1)];
			...
			entity.Notes = (reader.IsDBNull(((int)WiscrColumn.Notes - 1)))?null:(System.String)reader[((int)WiscrColumn.Notes - 1)];
			...
			entity.CreateUserId = (System.Int32)reader[((int)WiscrColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)WiscrColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)WiscrColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)WiscrColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)WiscrColumn.Deleted - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, Ekip.Framework.Entities.Wiscr entity)
		{
			...
			entity.CubesPatternRawScore = Convert.IsDBNull(dataRow["CubesPatternRawScore"]) ? null : (System.Int32?)dataRow["CubesPatternRawScore"];
