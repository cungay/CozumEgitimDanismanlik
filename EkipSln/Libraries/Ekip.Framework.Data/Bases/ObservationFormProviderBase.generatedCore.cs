...
{	
	...
	{		
		...
		public static TList<ObservationForm> Fill(IDataReader reader, TList<ObservationForm> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.CreateUserId = (System.Int32)reader[((int)ObservationFormColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)ObservationFormColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ObservationFormColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)ObservationFormColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)ObservationFormColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.ObservationForm entity)
		{
			...
			entity.CreateUserId = (System.Int32)reader[((int)ObservationFormColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)ObservationFormColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ObservationFormColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)ObservationFormColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)ObservationFormColumn.Deleted - 1)];
