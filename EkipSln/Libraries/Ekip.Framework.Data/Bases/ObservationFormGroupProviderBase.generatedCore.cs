...
{	
	...
	{		
		...
		public static TList<ObservationFormGroup> Fill(IDataReader reader, TList<ObservationFormGroup> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.CreateDate = (System.DateTime)reader[((int)ObservationFormGroupColumn.CreateDate - 1)];
					c.UpdateDate = (reader.IsDBNull(((int)ObservationFormGroupColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)ObservationFormGroupColumn.UpdateDate - 1)];
					c.CreateUserId = (System.Int32)reader[((int)ObservationFormGroupColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)ObservationFormGroupColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ObservationFormGroupColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)ObservationFormGroupColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)ObservationFormGroupColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.ObservationFormGroup entity)
		{
			...
			entity.CreateDate = (System.DateTime)reader[((int)ObservationFormGroupColumn.CreateDate - 1)];
			entity.UpdateDate = (reader.IsDBNull(((int)ObservationFormGroupColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)ObservationFormGroupColumn.UpdateDate - 1)];
			entity.CreateUserId = (System.Int32)reader[((int)ObservationFormGroupColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)ObservationFormGroupColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ObservationFormGroupColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)ObservationFormGroupColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)ObservationFormGroupColumn.Deleted - 1)];
