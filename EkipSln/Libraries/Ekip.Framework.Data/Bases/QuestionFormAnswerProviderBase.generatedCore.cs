...
{	
	...
	{		
		...
		public static TList<QuestionFormAnswer> Fill(IDataReader reader, TList<QuestionFormAnswer> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.CreateDate = (System.DateTime)reader[((int)QuestionFormAnswerColumn.CreateDate - 1)];
					c.UpdateDate = (reader.IsDBNull(((int)QuestionFormAnswerColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)QuestionFormAnswerColumn.UpdateDate - 1)];
					c.CreateUserId = (System.Int32)reader[((int)QuestionFormAnswerColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)QuestionFormAnswerColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)QuestionFormAnswerColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)QuestionFormAnswerColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)QuestionFormAnswerColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.QuestionFormAnswer entity)
		{
			...
			entity.CreateDate = (System.DateTime)reader[((int)QuestionFormAnswerColumn.CreateDate - 1)];
			entity.UpdateDate = (reader.IsDBNull(((int)QuestionFormAnswerColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)QuestionFormAnswerColumn.UpdateDate - 1)];
			entity.CreateUserId = (System.Int32)reader[((int)QuestionFormAnswerColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)QuestionFormAnswerColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)QuestionFormAnswerColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)QuestionFormAnswerColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)QuestionFormAnswerColumn.Deleted - 1)];
