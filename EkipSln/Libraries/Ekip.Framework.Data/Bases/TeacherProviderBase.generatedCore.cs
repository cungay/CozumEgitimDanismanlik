...
{	
	...
	{		
		...
		public static TList<Teacher> Fill(IDataReader reader, TList<Teacher> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.CreateDate = (System.DateTime)reader[((int)TeacherColumn.CreateDate - 1)];
					c.UpdateDate = (reader.IsDBNull(((int)TeacherColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)TeacherColumn.UpdateDate - 1)];
					...
					c.Active = (System.Boolean)reader[((int)TeacherColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)TeacherColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Teacher entity)
		{
			...
			entity.CreateDate = (System.DateTime)reader[((int)TeacherColumn.CreateDate - 1)];
			entity.UpdateDate = (reader.IsDBNull(((int)TeacherColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)TeacherColumn.UpdateDate - 1)];
			...
			entity.Active = (System.Boolean)reader[((int)TeacherColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)TeacherColumn.Deleted - 1)];
