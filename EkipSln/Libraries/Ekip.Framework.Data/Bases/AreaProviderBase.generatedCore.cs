...
{	
	...
	{		
		...
		public Ekip.Framework.Entities.Area GetByAreaId(System.Int32 _areaId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Area"/> class.</returns>
		public Ekip.Framework.Entities.Area GetByAreaId(System.Int32 _areaId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Area"/> class.</returns>
		public Ekip.Framework.Entities.Area GetByAreaId(TransactionManager transactionManager, System.Int32 _areaId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Area"/> class.</returns>
		public Ekip.Framework.Entities.Area GetByAreaId(TransactionManager transactionManager, System.Int32 _areaId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Area"/> class.</returns>
		public Ekip.Framework.Entities.Area GetByAreaId(System.Int32 _areaId, int start, int pageLength, out int count)
		{
			return GetByAreaId(null, _areaId, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Area"/> class.</returns>
		public abstract Ekip.Framework.Entities.Area GetByAreaId(TransactionManager transactionManager, System.Int32 _areaId, int start, int pageLength, out int count);
		...
		public static TList<Area> Fill(IDataReader reader, TList<Area> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.CreateDate = (reader.IsDBNull(((int)AreaColumn.CreateDate - 1)))?null:(System.DateTime?)reader[((int)AreaColumn.CreateDate - 1)];
					c.UpdateDate = (reader.IsDBNull(((int)AreaColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)AreaColumn.UpdateDate - 1)];
					c.CreateUserId = (System.Int32)reader[((int)AreaColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)AreaColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)AreaColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)AreaColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)AreaColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Area entity)
		{
			...
			entity.CreateDate = (reader.IsDBNull(((int)AreaColumn.CreateDate - 1)))?null:(System.DateTime?)reader[((int)AreaColumn.CreateDate - 1)];
			entity.UpdateDate = (reader.IsDBNull(((int)AreaColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)AreaColumn.UpdateDate - 1)];
			entity.CreateUserId = (System.Int32)reader[((int)AreaColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)AreaColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)AreaColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)AreaColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)AreaColumn.Deleted - 1)];
