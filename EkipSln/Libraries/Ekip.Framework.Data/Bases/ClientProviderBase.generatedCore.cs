...
{	
	...
	{		
		...
		public static TList<Client> Fill(IDataReader reader, TList<Client> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.FullName = (reader.IsDBNull(((int)ClientColumn.FullName - 1)))?null:(System.String)reader[((int)ClientColumn.FullName - 1)];
					...
					c.Gender = (reader.IsDBNull(((int)ClientColumn.Gender - 1)))?null:(System.Byte?)reader[((int)ClientColumn.Gender - 1)];
					c.Blood = (reader.IsDBNull(((int)ClientColumn.Blood - 1)))?null:(System.Byte?)reader[((int)ClientColumn.Blood - 1)];
					...
					c.FamilyStatus = (reader.IsDBNull(((int)ClientColumn.FamilyStatus - 1)))?null:(System.Byte?)reader[((int)ClientColumn.FamilyStatus - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Client entity)
		{
			...
			entity.FullName = (reader.IsDBNull(((int)ClientColumn.FullName - 1)))?null:(System.String)reader[((int)ClientColumn.FullName - 1)];
			...
			entity.Gender = (reader.IsDBNull(((int)ClientColumn.Gender - 1)))?null:(System.Byte?)reader[((int)ClientColumn.Gender - 1)];
			entity.Blood = (reader.IsDBNull(((int)ClientColumn.Blood - 1)))?null:(System.Byte?)reader[((int)ClientColumn.Blood - 1)];
			...
			entity.FamilyStatus = (reader.IsDBNull(((int)ClientColumn.FamilyStatus - 1)))?null:(System.Byte?)reader[((int)ClientColumn.FamilyStatus - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, Ekip.Framework.Entities.Client entity)
		{
			...
			entity.Gender = Convert.IsDBNull(dataRow["Gender"]) ? null : (System.Byte?)dataRow["Gender"];
			entity.Blood = Convert.IsDBNull(dataRow["Blood"]) ? null : (System.Byte?)dataRow["Blood"];
			...
			entity.FamilyStatus = Convert.IsDBNull(dataRow["FamilyStatus"]) ? null : (System.Byte?)dataRow["FamilyStatus"];
