...
{	
	...
	{		
		...
		public static TList<Client> Fill(IDataReader reader, TList<Client> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.CalenderAgeId = (reader.IsDBNull(((int)ClientColumn.CalenderAgeId - 1)))?null:(System.Byte?)reader[((int)ClientColumn.CalenderAgeId - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Client entity)
		{
			...
			entity.CalenderAgeId = (reader.IsDBNull(((int)ClientColumn.CalenderAgeId - 1)))?null:(System.Byte?)reader[((int)ClientColumn.CalenderAgeId - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, Ekip.Framework.Entities.Client entity)
		{
			...
			entity.CalenderAgeId = Convert.IsDBNull(dataRow["CalenderAgeId"]) ? null : (System.Byte?)dataRow["CalenderAgeId"];
