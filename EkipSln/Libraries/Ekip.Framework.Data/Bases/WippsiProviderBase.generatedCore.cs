...
{	
	...
	{		
		...
		public static TList<Wippsi> Fill(IDataReader reader, TList<Wippsi> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.SeanceId = (reader.IsDBNull(((int)WippsiColumn.SeanceId - 1)))?null:(System.Int32?)reader[((int)WippsiColumn.SeanceId - 1)];
					...
					c.Notes = (reader.IsDBNull(((int)WippsiColumn.Notes - 1)))?null:(System.String)reader[((int)WippsiColumn.Notes - 1)];
					...
					c.CreateUserId = (System.Int32)reader[((int)WippsiColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)WippsiColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)WippsiColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)WippsiColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)WippsiColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Wippsi entity)
		{
			...
			entity.SeanceId = (reader.IsDBNull(((int)WippsiColumn.SeanceId - 1)))?null:(System.Int32?)reader[((int)WippsiColumn.SeanceId - 1)];
			...
			entity.Notes = (reader.IsDBNull(((int)WippsiColumn.Notes - 1)))?null:(System.String)reader[((int)WippsiColumn.Notes - 1)];
			...
			entity.CreateUserId = (System.Int32)reader[((int)WippsiColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)WippsiColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)WippsiColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)WippsiColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)WippsiColumn.Deleted - 1)];
