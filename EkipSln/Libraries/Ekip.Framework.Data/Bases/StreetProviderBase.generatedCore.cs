...
{	
	...
	{		
		...
		{
			return Delete(transactionManager, key.StreetId);
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		public bool Delete(System.Int32 _streetId)
		{
			return Delete(null, _streetId);
		}
		...
		/// <remarks>Deletes based on primary key(s).</remarks>
		/// <returns>Returns true if operation suceeded.</returns>
		public abstract bool Delete(TransactionManager transactionManager, System.Int32 _streetId);		
		...
		{
			return GetByStreetId(transactionManager, key.StreetId, start, pageLength);
		}
		...
		public Ekip.Framework.Entities.Street GetByStreetId(System.Int32 _streetId)
		{
			int count = -1;
			return GetByStreetId(null,_streetId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Street"/> class.</returns>
		public Ekip.Framework.Entities.Street GetByStreetId(System.Int32 _streetId, int start, int pageLength)
		{
			int count = -1;
			return GetByStreetId(null, _streetId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Street"/> class.</returns>
		public Ekip.Framework.Entities.Street GetByStreetId(TransactionManager transactionManager, System.Int32 _streetId)
		{
			int count = -1;
			return GetByStreetId(transactionManager, _streetId, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Street"/> class.</returns>
		public Ekip.Framework.Entities.Street GetByStreetId(TransactionManager transactionManager, System.Int32 _streetId, int start, int pageLength)
		{
			int count = -1;
			return GetByStreetId(transactionManager, _streetId, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Street"/> class.</returns>
		public Ekip.Framework.Entities.Street GetByStreetId(System.Int32 _streetId, int start, int pageLength, out int count)
		{
			return GetByStreetId(null, _streetId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Street"/> class.</returns>
		public abstract Ekip.Framework.Entities.Street GetByStreetId(TransactionManager transactionManager, System.Int32 _streetId, int start, int pageLength, out int count);
		...
		public static TList<Street> Fill(IDataReader reader, TList<Street> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int32)reader[((int)StreetColumn.StreetId - 1)]).ToString();
					...
					))
				{
					...
					c.StreetId = (System.Int32)reader[((int)StreetColumn.StreetId - 1)];
					...
					c.CreateUserId = (System.Int32)reader[((int)StreetColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)StreetColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)StreetColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)StreetColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)StreetColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Street entity)
		{
			...
			entity.StreetId = (System.Int32)reader[((int)StreetColumn.StreetId - 1)];
			...
			entity.CreateUserId = (System.Int32)reader[((int)StreetColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)StreetColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)StreetColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)StreetColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)StreetColumn.Deleted - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, Ekip.Framework.Entities.Street entity)
		{
			...
			entity.StreetId = (System.Int32)dataRow["StreetId"];
		...
		public override void DeepLoad(TransactionManager transactionManager, Ekip.Framework.Entities.Street entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
				...
				&& entity.NeighborhoodIdSource == null)
			{
				...
				if (tmpEntity != null)
					...
					entity.NeighborhoodIdSource = DataRepository.NeighborhoodProvider.GetByNeighborhoodId(transactionManager, entity.NeighborhoodId);		
		...
		{	
				...
				&& entity.NeighborhoodIdSource != null)
			{
				...
				entity.NeighborhoodId = entity.NeighborhoodIdSource.NeighborhoodId;
			}
			#endregion 
