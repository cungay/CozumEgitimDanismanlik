...
{	
	...
	{		
		...
		public static TList<QuestionFormGroup> Fill(IDataReader reader, TList<QuestionFormGroup> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.CreateDate = (System.DateTime)reader[((int)QuestionFormGroupColumn.CreateDate - 1)];
					c.UpdateDate = (reader.IsDBNull(((int)QuestionFormGroupColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)QuestionFormGroupColumn.UpdateDate - 1)];
					c.CreateUserId = (System.Int32)reader[((int)QuestionFormGroupColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)QuestionFormGroupColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)QuestionFormGroupColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)QuestionFormGroupColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)QuestionFormGroupColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.QuestionFormGroup entity)
		{
			...
			entity.CreateDate = (System.DateTime)reader[((int)QuestionFormGroupColumn.CreateDate - 1)];
			entity.UpdateDate = (reader.IsDBNull(((int)QuestionFormGroupColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)QuestionFormGroupColumn.UpdateDate - 1)];
			entity.CreateUserId = (System.Int32)reader[((int)QuestionFormGroupColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)QuestionFormGroupColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)QuestionFormGroupColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)QuestionFormGroupColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)QuestionFormGroupColumn.Deleted - 1)];
