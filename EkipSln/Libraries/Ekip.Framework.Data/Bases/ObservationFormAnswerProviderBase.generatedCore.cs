...
{	
	...
	{		
		...
		public static TList<ObservationFormAnswer> Fill(IDataReader reader, TList<ObservationFormAnswer> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.CreateDate = (System.DateTime)reader[((int)ObservationFormAnswerColumn.CreateDate - 1)];
					c.UpdateDate = (reader.IsDBNull(((int)ObservationFormAnswerColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)ObservationFormAnswerColumn.UpdateDate - 1)];
					c.CreateUserId = (System.Int32)reader[((int)ObservationFormAnswerColumn.CreateUserId - 1)];
					c.UpdateUserId = (reader.IsDBNull(((int)ObservationFormAnswerColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ObservationFormAnswerColumn.UpdateUserId - 1)];
					c.Active = (System.Boolean)reader[((int)ObservationFormAnswerColumn.Active - 1)];
					c.Deleted = (System.Boolean)reader[((int)ObservationFormAnswerColumn.Deleted - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.ObservationFormAnswer entity)
		{
			...
			entity.CreateDate = (System.DateTime)reader[((int)ObservationFormAnswerColumn.CreateDate - 1)];
			entity.UpdateDate = (reader.IsDBNull(((int)ObservationFormAnswerColumn.UpdateDate - 1)))?null:(System.DateTime?)reader[((int)ObservationFormAnswerColumn.UpdateDate - 1)];
			entity.CreateUserId = (System.Int32)reader[((int)ObservationFormAnswerColumn.CreateUserId - 1)];
			entity.UpdateUserId = (reader.IsDBNull(((int)ObservationFormAnswerColumn.UpdateUserId - 1)))?null:(System.Int32?)reader[((int)ObservationFormAnswerColumn.UpdateUserId - 1)];
			entity.Active = (System.Boolean)reader[((int)ObservationFormAnswerColumn.Active - 1)];
			entity.Deleted = (System.Boolean)reader[((int)ObservationFormAnswerColumn.Deleted - 1)];
