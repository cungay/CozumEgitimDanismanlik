	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.ClientId.GetHashCode() ^ 
					...
					((this.CalendarAgeId == null) ? string.Empty : this.CalendarAgeId.ToString()).GetHashCode() ^ 
		...
		public static bool ValueEquals(ClientBase Object1, ClientBase Object2)
		{
			...
			if (Object1.BirthDate != Object2.BirthDate)
				equal = false;
			if ( Object1.CalendarAgeId != null && Object2.CalendarAgeId != null )
			{
				if (Object1.CalendarAgeId != Object2.CalendarAgeId)
					equal = false;
			}
			else if (Object1.CalendarAgeId == null ^ Object2.CalendarAgeId == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(Client rhs, ClientColumn which)
        {
            switch (which)
            {
            	...
            	case ClientColumn.CalendarAgeId:
            		return this.CalendarAgeId.Value.CompareTo(rhs.CalendarAgeId.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				...
				this.CurrentAge,
				this.BirthDate,
				(this.CalendarAgeId == null) ? string.Empty : this.CalendarAgeId.ToString(),
				this.FullName,
	...
	internal protected class ClientEntityData : ICloneable, ICloneableEx
	{
		...
		/// </summary>
		[DataMember]
		public System.Int32? CalendarAgeId = null;
	...
	public enum ClientColumn : int
	{
		...
		[ColumnEnum("CalendarAgeId", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		CalendarAgeId = 7,
		/// <summary>
		/// FullName : 
		/// </summary>
