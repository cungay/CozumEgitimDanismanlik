...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public ClientBase(System.Int32 _fileNumber, System.DateTime _firstContactDate, System.Int32 _firstContactAge, 
			System.Int32 _currentAge, System.DateTime _birthDate, System.Int32 _calendarAgeId, System.String _fullName, 
			System.String _middleName, System.String _reference, System.Int32 _motherId, System.Int32 _fatherId, 
			System.Int32? _addressId, System.String _ıdCard, System.Byte? _gender, System.Byte? _blood, System.String _pediatrician, 
			System.Int32 _countOfChild, System.Byte? _familyStatus, System.String _notes, System.DateTime _createDate, 
			...
			System.Boolean _deleted)
		{
			...
			this.FirstContactAge = _firstContactAge;
			this.CurrentAge = _currentAge;
		...
		///<param name="_active"></param>
		///<param name="_deleted"></param>
		public static Client CreateClient(System.Int32 _fileNumber, System.DateTime _firstContactDate, System.Int32 _firstContactAge, 
			System.Int32 _currentAge, System.DateTime _birthDate, System.Int32 _calendarAgeId, System.String _fullName, 
			System.String _middleName, System.String _reference, System.Int32 _motherId, System.Int32 _fatherId, 
			System.Int32? _addressId, System.String _ıdCard, System.Byte? _gender, System.Byte? _blood, System.String _pediatrician, 
			System.Int32 _countOfChild, System.Byte? _familyStatus, System.String _notes, System.DateTime _createDate, 
			...
			System.Boolean _deleted)
		{
			...
			newClient.FirstContactAge = _firstContactAge;
			newClient.CurrentAge = _currentAge;
			newClient.BirthDate = _birthDate;
			newClient.CalendarAgeId = _calendarAgeId;
			...
			newClient.CreateDate = _createDate;
			newClient.UpdateDate = _updateDate;
			newClient.CreateUserId = _createUserId;
			newClient.UpdateUserId = _updateUserId;
			newClient.Active = _active;
			newClient.Deleted = _deleted;
			return newClient;
		}
		...
		/// <summary>
		/// 	Gets or sets the FirstContactAge property. 
		///		
		/// </summary>
		/// <value>This type is int.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, false)]
		public virtual System.Int32 FirstContactAge
		{
			get
			{
				return this.entityData.FirstContactAge; 
			}
			
			set
			{
				if (this.entityData.FirstContactAge == value)
					return;
				
                OnPropertyChanging("FirstContactAge");                    
				OnColumnChanging(ClientColumn.FirstContactAge, this.entityData.FirstContactAge);
				this.entityData.FirstContactAge = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientColumn.FirstContactAge, this.entityData.FirstContactAge);
				OnPropertyChanged("FirstContactAge");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the CurrentAge property. 
		///		
		/// </summary>
		/// <value>This type is int.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, false)]
		public virtual System.Int32 CurrentAge
		{
			get
			{
				return this.entityData.CurrentAge; 
			}
			
			set
			{
				if (this.entityData.CurrentAge == value)
					return;
				
                OnPropertyChanging("CurrentAge");                    
				OnColumnChanging(ClientColumn.CurrentAge, this.entityData.CurrentAge);
				this.entityData.CurrentAge = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientColumn.CurrentAge, this.entityData.CurrentAge);
				OnPropertyChanged("CurrentAge");
			}
		}
		...
		public virtual System.Int32 CalendarAgeId
		{
			...
			set
			{
				...
				OnColumnChanging(ClientColumn.CalendarAgeId, this.entityData.CalendarAgeId);
				this.entityData.CalendarAgeId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientColumn.CalendarAgeId, this.entityData.CalendarAgeId);
		...
		public virtual System.DateTime CreateDate
		{
			...
			set
			{
				...
				OnColumnChanging(ClientColumn.CreateDate, this.entityData.CreateDate);
				this.entityData.CreateDate = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientColumn.CreateDate, this.entityData.CreateDate);
		...
		public virtual System.DateTime? UpdateDate
		{
			...
			set
			{
				...
				OnColumnChanging(ClientColumn.UpdateDate, this.entityData.UpdateDate);
				this.entityData.UpdateDate = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientColumn.UpdateDate, this.entityData.UpdateDate);
		...
		public virtual System.Int32 CreateUserId
		{
			...
			set
			{
				...
				OnColumnChanging(ClientColumn.CreateUserId, this.entityData.CreateUserId);
				this.entityData.CreateUserId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientColumn.CreateUserId, this.entityData.CreateUserId);
		...
		public virtual System.Int32? UpdateUserId
		{
			...
			set
			{
				...
				OnColumnChanging(ClientColumn.UpdateUserId, this.entityData.UpdateUserId);
				this.entityData.UpdateUserId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientColumn.UpdateUserId, this.entityData.UpdateUserId);
		...
		public virtual System.Boolean Active
		{
			...
			set
			{
				...
				OnColumnChanging(ClientColumn.Active, this.entityData.Active);
				this.entityData.Active = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientColumn.Active, this.entityData.Active);
		...
		public virtual System.Boolean Deleted
		{
			...
			set
			{
				...
				OnColumnChanging(ClientColumn.Deleted, this.entityData.Deleted);
				this.entityData.Deleted = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientColumn.Deleted, this.entityData.Deleted);
		...
		///	which are related to this object through the relation FK_ClientEducation_Client
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"ClientId", "FileNumber", "FirstContactDate", "FirstContactAge", "CurrentAge", "BirthDate", "CalendarAgeId", "FullName", "MiddleName", "Reference", "MotherId", "FatherId", "AddressId", "IdCard", "Gender", "Blood", "Pediatrician", "CountOfChild", "FamilyStatus", "Notes", "CreateDate", "UpdateDate", "CreateUserId", "UpdateUserId", "Active", "Deleted"};
			}
		}
		#endregion 
		...
		protected virtual Client Copy(IDictionary existingCopies)
		{
			...
			copy.SuppressEntityEvents = true;
				...
				copy.FirstContactAge = this.FirstContactAge;
				copy.CurrentAge = this.CurrentAge;
		...
		public bool IsPropertyChanged(ClientColumn column)
		{
			switch(column)
			{
					...
					case ClientColumn.FirstContactAge:
					return entityData.FirstContactAge != _originalData.FirstContactAge;
					case ClientColumn.CurrentAge:
					return entityData.CurrentAge != _originalData.CurrentAge;
					case ClientColumn.BirthDate:
					return entityData.BirthDate != _originalData.BirthDate;
					case ClientColumn.CalendarAgeId:
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.FirstContactAge != _originalData.FirstContactAge;
			result = result || entityData.CurrentAge != _originalData.CurrentAge;
		...
		public Client GetOriginalEntity()
		{
			if (_originalData != null)
				...
				_originalData.FirstContactAge,
				_originalData.CurrentAge,
				_originalData.BirthDate,
				_originalData.CalendarAgeId,
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.ClientId.GetHashCode() ^ 
					...
					this.FirstContactDate.GetHashCode() ^ 
					this.FirstContactAge.GetHashCode() ^ 
					this.CurrentAge.GetHashCode() ^ 
					this.BirthDate.GetHashCode() ^ 
					this.CalendarAgeId.GetHashCode() ^ 
					...
					this.MotherId.GetHashCode() ^ 
					this.FatherId.GetHashCode() ^ 
					...
					((this.Blood == null) ? string.Empty : this.Blood.ToString()).GetHashCode() ^ 
					((this.Pediatrician == null) ? string.Empty : this.Pediatrician.ToString()).GetHashCode() ^ 
					this.CountOfChild.GetHashCode() ^ 
					((this.FamilyStatus == null) ? string.Empty : this.FamilyStatus.ToString()).GetHashCode() ^ 
		...
		public static bool ValueEquals(ClientBase Object1, ClientBase Object2)
		{
			...
			if (Object1.FirstContactDate != Object2.FirstContactDate)
				equal = false;
			if (Object1.FirstContactAge != Object2.FirstContactAge)
				equal = false;
			if (Object1.CurrentAge != Object2.CurrentAge)
				equal = false;
			...
			if ( Object1.Blood != null && Object2.Blood != null )
			{
				if (Object1.Blood != Object2.Blood)
					equal = false;
			}
			else if (Object1.Blood == null ^ Object2.Blood == null )
			{
				equal = false;
			}
			...
			if (Object1.CountOfChild != Object2.CountOfChild)
				equal = false;
			if ( Object1.FamilyStatus != null && Object2.FamilyStatus != null )
			{
				if (Object1.FamilyStatus != Object2.FamilyStatus)
					equal = false;
			}
			else if (Object1.FamilyStatus == null ^ Object2.FamilyStatus == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(Client rhs, ClientColumn which)
        {
            switch (which)
            {
            	...
            	case ClientColumn.FirstContactDate:
            		return this.FirstContactDate.CompareTo(rhs.FirstContactDate);
            		
            		                 
            	
            	
            	case ClientColumn.FirstContactAge:
            		return this.FirstContactAge.CompareTo(rhs.FirstContactAge);
            		
            		                 
            	
            	
            	case ClientColumn.CurrentAge:
            		return this.CurrentAge.CompareTo(rhs.CurrentAge);
            	...
            	case ClientColumn.Blood:
            		return this.Blood.Value.CompareTo(rhs.Blood.Value);
            	...
            	case ClientColumn.FamilyStatus:
            		return this.FamilyStatus.Value.CompareTo(rhs.FamilyStatus.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{27}{26}- ClientId: {0}{26}- FileNumber: {1}{26}- FirstContactDate: {2}{26}- FirstContactAge: {3}{26}- CurrentAge: {4}{26}- BirthDate: {5}{26}- CalendarAgeId: {6}{26}- FullName: {7}{26}- MiddleName: {8}{26}- Reference: {9}{26}- MotherId: {10}{26}- FatherId: {11}{26}- AddressId: {12}{26}- IdCard: {13}{26}- Gender: {14}{26}- Blood: {15}{26}- Pediatrician: {16}{26}- CountOfChild: {17}{26}- FamilyStatus: {18}{26}- Notes: {19}{26}- CreateDate: {20}{26}- UpdateDate: {21}{26}- CreateUserId: {22}{26}- UpdateUserId: {23}{26}- Active: {24}{26}- Deleted: {25}{26}{28}", 
				this.ClientId,
				this.FileNumber,
				...
				(this.Blood == null) ? string.Empty : this.Blood.ToString(),
				(this.Pediatrician == null) ? string.Empty : this.Pediatrician.ToString(),
				this.CountOfChild,
				(this.FamilyStatus == null) ? string.Empty : this.FamilyStatus.ToString(),
	...
	internal protected class ClientEntityData : ICloneable, ICloneableEx
	{
		...
		/// </summary>
		[DataMember]
		public System.DateTime FirstContactDate = DateTime.MinValue;
		
		/// <summary>
		/// FirstContactAge : 
		/// </summary>
		[DataMember]
		public System.Int32 FirstContactAge = (int)0;
		
		/// <summary>
		/// CurrentAge : 
		/// </summary>
		[DataMember]
		public System.Int32 CurrentAge = (int)0;
		...
		/// </summary>
		[DataMember]
		public System.Int32 CalendarAgeId = (int)0;
		...
		/// </summary>
		[DataMember]
		public System.Int32 MotherId = (int)0;
		
		/// <summary>
		/// FatherId : 
		/// </summary>
		[DataMember]
		public System.Int32 FatherId = (int)0;
		...
		/// </summary>
		[DataMember]
		public System.Byte? Gender = null;
		
		/// <summary>
		/// Blood : 
		/// </summary>
		[DataMember]
		public System.Byte? Blood = null;
		...
		/// </summary>
		[DataMember]
		public System.Byte? FamilyStatus = null;
		...
		private TList<ClientEducation> _clientEducationClientId;
		...
		public TList<ClientEducation> ClientEducationCollection
		{
			get
			{
				if (_clientEducationClientId == null)
				{
				_clientEducationClientId = new TList<ClientEducation>();
				}
	
				return _clientEducationClientId;
			}
			set { _clientEducationClientId = value; }
		}
		...
		public Object Clone()
		{
			...
			_tmp.FirstContactAge = this.FirstContactAge;
			_tmp.CurrentAge = this.CurrentAge;
			...
			if (this._clientEducationClientId != null)
	...
	public enum ClientColumn : int
	{
		...
		[ColumnEnum("FirstContactDate", typeof(System.DateTime), System.Data.DbType.DateTime, false, false, false)]
		FirstContactDate = 3,
		/// <summary>
		/// FirstContactAge : 
		/// </summary>
		[EnumTextValue("First Contact Age")]
		[ColumnEnum("FirstContactAge", typeof(System.Int32), System.Data.DbType.Int32, false, false, false)]
		FirstContactAge = 4,
		/// <summary>
		/// CurrentAge : 
		/// </summary>
		[EnumTextValue("Current Age")]
		[ColumnEnum("CurrentAge", typeof(System.Int32), System.Data.DbType.Int32, false, false, false)]
		CurrentAge = 5,
		/// <summary>
		/// BirthDate : 
		/// </summary>
		...
		[ColumnEnum("CalendarAgeId", typeof(System.Int32), System.Data.DbType.Int32, false, false, false)]
		CalendarAgeId = 7,
		/// <summary>
		/// FullName : 
		/// </summary>
		[EnumTextValue("Full Name")]
		[ColumnEnum("FullName", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 100)]
		FullName = 8,
		/// <summary>
		/// MiddleName : 
		/// </summary>
		...
		[ColumnEnum("MotherId", typeof(System.Int32), System.Data.DbType.Int32, false, false, false)]
		MotherId = 11,
		/// <summary>
		/// FatherId : 
		/// </summary>
		[EnumTextValue("Father Id")]
		[ColumnEnum("FatherId", typeof(System.Int32), System.Data.DbType.Int32, false, false, false)]
		FatherId = 12,
		/// <summary>
		/// AddressId : 
		/// </summary>
		...
		[ColumnEnum("Gender", typeof(System.Byte), System.Data.DbType.Byte, false, false, true)]
		Gender = 15,
		/// <summary>
		/// Blood : 
		/// </summary>
		[EnumTextValue("Blood")]
		[ColumnEnum("Blood", typeof(System.Byte), System.Data.DbType.Byte, false, false, true)]
		Blood = 16,
		/// <summary>
		/// Pediatrician : 
		/// </summary>
		...
		[ColumnEnum("FamilyStatus", typeof(System.Byte), System.Data.DbType.Byte, false, false, true)]
		FamilyStatus = 19,
		/// <summary>
		/// Notes : 
		/// </summary>
