...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"MotherId", "FullName", "Title", "Email", "Fax", "HomePhone", "BusinessPhone", "MobilePhone", "JobId", "Notes", "CreateDate", "UpdateDate", "CreateUserId", "UpdateUserId", "Active", "Deleted"};
			}
		}
		#endregion 
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{17}{16}- MotherId: {0}{16}- FullName: {1}{16}- Title: {2}{16}- Email: {3}{16}- Fax: {4}{16}- HomePhone: {5}{16}- BusinessPhone: {6}{16}- MobilePhone: {7}{16}- JobId: {8}{16}- Notes: {9}{16}- CreateDate: {10}{16}- UpdateDate: {11}{16}- CreateUserId: {12}{16}- UpdateUserId: {13}{16}- Active: {14}{16}- Deleted: {15}{16}{18}", 
				this.MotherId,
