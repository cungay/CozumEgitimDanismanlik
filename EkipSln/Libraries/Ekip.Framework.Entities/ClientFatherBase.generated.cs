...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public ClientFatherBase(System.String _fullName, System.String _title, System.String _email, 
			...
			System.String _otherPhone, System.Int32? _jobId, System.String _notes, System.Byte _fatherStatusId, 
			...
			System.Int32? _updateUserId, System.Boolean _active, System.Boolean _deleted)
		{
			...
			this.JobId = _jobId;
			this.Notes = _notes;
			this.FatherStatusId = _fatherStatusId;
			...
			System.Int32? _updateUserId, System.Boolean _active, System.Boolean _deleted)
		{
			...
			newClientFather.OtherPhone = _otherPhone;
			newClientFather.JobId = _jobId;
			newClientFather.Notes = _notes;
			newClientFather.FatherStatusId = _fatherStatusId;
		...
		public virtual System.String OtherPhone
		{
			...
			set
			{
				...
				OnColumnChanging(ClientFatherColumn.OtherPhone, this.entityData.OtherPhone);
				this.entityData.OtherPhone = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientFatherColumn.OtherPhone, this.entityData.OtherPhone);
		...
		/// <summary>
		/// 	Gets or sets the FatherStatusId property. 
		///		
		/// </summary>
		...
		public virtual System.Byte FatherStatusId
		{
			get
			{
				return this.entityData.FatherStatusId; 
			}
			
			set
			{
				if (this.entityData.FatherStatusId == value)
					return;
				
                OnPropertyChanging("FatherStatusId");                    
				OnColumnChanging(ClientFatherColumn.FatherStatusId, this.entityData.FatherStatusId);
				this.entityData.FatherStatusId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientFatherColumn.FatherStatusId, this.entityData.FatherStatusId);
				OnPropertyChanged("FatherStatusId");
			}
		}
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"FatherId", "FullName", "Title", "Email", "Fax", "HomePhone", "BusinessPhone", "MobilePhone", "OtherPhone", "JobId", "Notes", "FatherStatusId", "CreateDate", "UpdateDate", "CreateUserId", "UpdateUserId", "Active", "Deleted"};
			}
		}
		#endregion 
		...
		protected virtual ClientFather Copy(IDictionary existingCopies)
		{
			...
			copy.SuppressEntityEvents = true;
				...
				copy.FatherStatusId = this.FatherStatusId;
		...
		public bool IsPropertyChanged(ClientFatherColumn column)
		{
			switch(column)
			{
					...
					case ClientFatherColumn.OtherPhone:
					...
					case ClientFatherColumn.FatherStatusId:
					return entityData.FatherStatusId != _originalData.FatherStatusId;
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.FatherStatusId != _originalData.FatherStatusId;
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.FatherId.GetHashCode() ^ 
					...
					this.FatherStatusId.GetHashCode() ^ 
		...
		public static bool ValueEquals(ClientFatherBase Object1, ClientFatherBase Object2)
		{
			...
			if (Object1.FatherStatusId != Object2.FatherStatusId)
				equal = false;
...
/*
        ...
        public int CompareTo(ClientFather rhs, ClientFatherColumn which)
        {
            switch (which)
            {
            	...
            	case ClientFatherColumn.FatherStatusId:
            		return this.FatherStatusId.CompareTo(rhs.FatherStatusId);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{19}{18}- FatherId: {0}{18}- FullName: {1}{18}- Title: {2}{18}- Email: {3}{18}- Fax: {4}{18}- HomePhone: {5}{18}- BusinessPhone: {6}{18}- MobilePhone: {7}{18}- OtherPhone: {8}{18}- JobId: {9}{18}- Notes: {10}{18}- FatherStatusId: {11}{18}- CreateDate: {12}{18}- UpdateDate: {13}{18}- CreateUserId: {14}{18}- UpdateUserId: {15}{18}- Active: {16}{18}- Deleted: {17}{18}{20}", 
				this.FatherId,
	...
	internal protected class ClientFatherEntityData : ICloneable, ICloneableEx
	{
		...
		/// </summary>
		[DataMember]
		public System.Byte FatherStatusId = (byte)0;
		...
		public Object Clone()
		{
			...
			_tmp.FatherStatusId = this.FatherStatusId;
	...
	public enum ClientFatherColumn : int
	{
		...
		/// FatherStatusId : 
		/// </summary>
		[EnumTextValue("Father Status Id")]
		[ColumnEnum("FatherStatusId", typeof(System.Byte), System.Data.DbType.Byte, false, false, false)]
		FatherStatusId = 12,
		/// <summary>
		/// CreateDate : 
		/// </summary>
