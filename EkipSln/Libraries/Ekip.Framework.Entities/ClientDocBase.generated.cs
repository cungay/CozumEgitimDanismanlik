...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public ClientDocBase(System.Int32 _clientDocId, System.Int32 _clientId, System.String _fileName, 
			System.String _fullName, System.String _filePath, System.DateTime _creationDate, System.TimeSpan _creationTime, 
			System.String _fileExtension, System.Double _fileSize, System.Byte[] _fileContent, System.String _notes, 
			System.DateTime _createDate, System.DateTime? _updateDate, System.Int32 _createUserId, System.Int32? _updateUserId, 
			System.Boolean _active, System.Boolean _deleted)
		{
			this.entityData = new ClientDocEntityData();
			this.backupData = null;

			this.ClientDocId = _clientDocId;
		...
		///<param name="_active"></param>
		///<param name="_deleted"></param>
		public static ClientDoc CreateClientDoc(System.Int32 _clientDocId, System.Int32 _clientId, System.String _fileName, 
			System.String _fullName, System.String _filePath, System.DateTime _creationDate, System.TimeSpan _creationTime, 
			System.String _fileExtension, System.Double _fileSize, System.Byte[] _fileContent, System.String _notes, 
			System.DateTime _createDate, System.DateTime? _updateDate, System.Int32 _createUserId, System.Int32? _updateUserId, 
			System.Boolean _active, System.Boolean _deleted)
		{
			...
			newClientDoc.ClientDocId = _clientDocId;
			...
			newClientDoc.Notes = _notes;
			newClientDoc.CreateDate = _createDate;
			newClientDoc.UpdateDate = _updateDate;
			newClientDoc.CreateUserId = _createUserId;
			newClientDoc.UpdateUserId = _updateUserId;
			newClientDoc.Active = _active;
			newClientDoc.Deleted = _deleted;
			return newClientDoc;
		}
		...
		/// <summary>
		/// 	Gets or sets the ClientDocId property. 
		///		
		/// </summary>
		...
		public virtual System.Int32 ClientDocId
		{
			get
			{
				return this.entityData.ClientDocId; 
			}
			
			set
			{
				if (this.entityData.ClientDocId == value)
					return;
				
                OnPropertyChanging("ClientDocId");                    
				OnColumnChanging(ClientDocColumn.ClientDocId, this.entityData.ClientDocId);
				this.entityData.ClientDocId = value;
				this.EntityId.ClientDocId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientDocColumn.ClientDocId, this.entityData.ClientDocId);
				OnPropertyChanged("ClientDocId");
			}
		}
		
		/// <summary>
		/// 	Get the original value of the ClientDocId property.
		///		
		/// </summary>
		/// <remarks>This is the original value of the ClientDocId property.</remarks>
		/// <value>This type is int</value>
		[BrowsableAttribute(false)/*, XmlIgnoreAttribute()*/]
		public  virtual System.Int32 OriginalClientDocId
		{
			get { return this.entityData.OriginalClientDocId; }
			set { this.entityData.OriginalClientDocId = value; }
		}
		...
		public virtual System.String Notes
		{
			...
			set
			{
				...
				OnColumnChanging(ClientDocColumn.Notes, this.entityData.Notes);
				this.entityData.Notes = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientDocColumn.Notes, this.entityData.Notes);
		...
		public virtual System.DateTime CreateDate
		{
			...
			set
			{
				...
				OnColumnChanging(ClientDocColumn.CreateDate, this.entityData.CreateDate);
				this.entityData.CreateDate = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientDocColumn.CreateDate, this.entityData.CreateDate);
		...
		public virtual System.DateTime? UpdateDate
		{
			...
			set
			{
				...
				OnColumnChanging(ClientDocColumn.UpdateDate, this.entityData.UpdateDate);
				this.entityData.UpdateDate = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientDocColumn.UpdateDate, this.entityData.UpdateDate);
		...
		public virtual System.Int32? UpdateUserId
		{
			...
			set
			{
				...
				OnColumnChanging(ClientDocColumn.UpdateUserId, this.entityData.UpdateUserId);
				this.entityData.UpdateUserId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientDocColumn.UpdateUserId, this.entityData.UpdateUserId);
		...
		public virtual System.Boolean Active
		{
			...
			set
			{
				...
				OnColumnChanging(ClientDocColumn.Active, this.entityData.Active);
				this.entityData.Active = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientDocColumn.Active, this.entityData.Active);
		...
		public virtual System.Boolean Deleted
		{
			...
			set
			{
				...
				OnColumnChanging(ClientDocColumn.Deleted, this.entityData.Deleted);
				this.entityData.Deleted = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ClientDocColumn.Deleted, this.entityData.Deleted);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"ClientDocId", "ClientId", "FileName", "FullName", "FilePath", "CreationDate", "CreationTime", "FileExtension", "FileSize", "FileContent", "Notes", "CreateDate", "UpdateDate", "CreateUserId", "UpdateUserId", "Active", "Deleted"};
			}
		}
		#endregion 
		...
		protected virtual ClientDoc Copy(IDictionary existingCopies)
		{
			...
			copy.SuppressEntityEvents = true;
				copy.ClientDocId = this.ClientDocId;
					copy.OriginalClientDocId = this.OriginalClientDocId;
		...
		public bool IsPropertyChanged(ClientDocColumn column)
		{
			switch(column)
			{
					case ClientDocColumn.ClientDocId:
					return entityData.ClientDocId != _originalData.ClientDocId;
					...
					case ClientDocColumn.Notes:
					return entityData.Notes != _originalData.Notes;
					case ClientDocColumn.CreateDate:
					return entityData.CreateDate != _originalData.CreateDate;
					case ClientDocColumn.UpdateDate:
		...
		{
			bool result = false;
			result = result || entityData.ClientDocId != _originalData.ClientDocId;
	...
	#region Value Semantics Instance Equality
        ...
        {
			return this.ClientDocId.GetHashCode() ^ 
		...
		public static bool ValueEquals(ClientDocBase Object1, ClientDocBase Object2)
		{
			...
			bool equal = true;
			if (Object1.ClientDocId != Object2.ClientDocId)
				equal = false;
...
/*
        ...
        public int CompareTo(ClientDoc rhs, ClientDocColumn which)
        {
            switch (which)
            {
            	...
            	case ClientDocColumn.ClientDocId:
            		return this.ClientDocId.CompareTo(rhs.ClientDocId);
        ...
        */
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					...
					.Append("|").Append( this.ClientDocId.ToString()).ToString();
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{18}{17}- ClientDocId: {0}{17}- ClientId: {1}{17}- FileName: {2}{17}- FullName: {3}{17}- FilePath: {4}{17}- CreationDate: {5}{17}- CreationTime: {6}{17}- FileExtension: {7}{17}- FileSize: {8}{17}- FileContent: {9}{17}- Notes: {10}{17}- CreateDate: {11}{17}- UpdateDate: {12}{17}- CreateUserId: {13}{17}- UpdateUserId: {14}{17}- Active: {15}{17}- Deleted: {16}{17}{19}", 
				this.ClientDocId,
				this.ClientId,
				this.FileName,
				this.FullName,
	...
	internal protected class ClientDocEntityData : ICloneable, ICloneableEx
	{
		...
		[DataMember]
		public System.Int32 ClientDocId;
			
		/// <summary>
		/// keep a copy of the original so it can be used for editable primary keys.
		/// </summary>
		[DataMember]
		public System.Int32 OriginalClientDocId;
		...
		public Object Clone()
		{
			...
			_tmp.ClientDocId = this.ClientDocId;
			_tmp.OriginalClientDocId = this.OriginalClientDocId;
	...
	public class ClientDocKey : EntityKeyBase
	{
		...
		public ClientDocKey(ClientDocBase entity)
		{
			...
			if ( entity != null )
			{
				this.ClientDocId = entity.ClientDocId;
			}
		...
		/// Initializes a new instance of the ClientDocKey class.
		/// </summary>
		public ClientDocKey(System.Int32 _clientDocId)
		{
			#region Init Properties
		...
		// member variable for the ClientDocId property
		private System.Int32 _clientDocId;
		...
		public System.Int32 ClientDocId
		{
			get { return _clientDocId; }
			set
			{
				if ( this.Entity != null )
					this.Entity.ClientDocId = value;
		...
		public override void Load(IDictionary values)
		{
			...
			if ( values != null )
			{
				ClientDocId = ( values["ClientDocId"] != null ) ? (System.Int32) EntityUtil.ChangeType(values["ClientDocId"], typeof(System.Int32)) : (int)0;
			}
		...
		public override IDictionary ToDictionary()
		{
			...
			values.Add("ClientDocId", ClientDocId);
		...
		public override string ToString()
		{
			return String.Format("ClientDocId: {0}{1}",
								ClientDocId,
								System.Environment.NewLine);
		}
	...
	public enum ClientDocColumn : int
	{
		...
		/// ClientDocId : 
		/// </summary>
		[EnumTextValue("Client Doc Id")]
		[ColumnEnum("ClientDocId", typeof(System.Int32), System.Data.DbType.Int32, true, false, false)]
		ClientDocId = 1,
		/// <summary>
		/// ClientId : 
		/// </summary>
