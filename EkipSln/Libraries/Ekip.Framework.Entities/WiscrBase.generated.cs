...
namespace Ekip.Framework.Entities
{
	...
	{		
		...
		public WiscrBase(System.Int32? _seanceId, System.Int32? _generalRawScore, System.Int32? _generalStandartScore, 
			System.Int32? _similarityRawScore, System.Int32? _similarityStandartScore, System.Int32? _arithmeticRawScore, 
			System.Int32? _arithmeticStandartScore, System.Int32? _wordRawScore, System.Int32? _wordStandartScore, System.Int32? _judgingRawScore, 
			System.Int32? _judgingStandartScore, System.Int32? _setOfNumbersRawScore, System.Int32? _setOfNumbersStandartScore, 
			System.Int32? _ımageDefineRawScore, System.Int32? _ımageDefineStandartScore, System.Int32? _ımageEditingRawScore, 
			System.Int32? _ımageEditingStandartScore, System.Int32? _cubesPatternRawScore, System.Int32? _cubesPatternStandartScore, 
			System.Int32? _partsMergeRawScore, System.Int32? _partsMergeStandartScore, System.Int32? _passwordRawScore, 
			System.Int32? _passwordStandartScore, System.Int32? _mazesRawScore, System.Int32? _mazesStandartScore, System.Int32? _totalVerbalScore, 
			System.Int32? _totalPerformanceScore, System.Int32? _totalScore, System.String _notes, System.DateTime _testDate, 
		...
		///<param name="_active"></param>
		///<param name="_deleted"></param>
		public static Wiscr CreateWiscr(System.Int32? _seanceId, System.Int32? _generalRawScore, System.Int32? _generalStandartScore, 
			System.Int32? _similarityRawScore, System.Int32? _similarityStandartScore, System.Int32? _arithmeticRawScore, 
			System.Int32? _arithmeticStandartScore, System.Int32? _wordRawScore, System.Int32? _wordStandartScore, System.Int32? _judgingRawScore, 
			System.Int32? _judgingStandartScore, System.Int32? _setOfNumbersRawScore, System.Int32? _setOfNumbersStandartScore, 
			System.Int32? _ımageDefineRawScore, System.Int32? _ımageDefineStandartScore, System.Int32? _ımageEditingRawScore, 
			...
			System.Boolean _active, System.Boolean _deleted)
		{
			...
			newWiscr.Notes = _notes;
			newWiscr.TestDate = _testDate;
			newWiscr.CreateDate = _createDate;
			newWiscr.UpdateDate = _updateDate;
			newWiscr.CreateUserId = _createUserId;
			newWiscr.UpdateUserId = _updateUserId;
			newWiscr.Active = _active;
			newWiscr.Deleted = _deleted;
			return newWiscr;
		}
		...
		public virtual System.Int32? SeanceId
		{
			...
			set
			{
				...
				OnColumnChanging(WiscrColumn.SeanceId, this.entityData.SeanceId);
				this.entityData.SeanceId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(WiscrColumn.SeanceId, this.entityData.SeanceId);
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Int32? CubesPatternRawScore
		{
			get
			{
		...
		public virtual System.String Notes
		{
			...
			set
			{
				...
				OnColumnChanging(WiscrColumn.Notes, this.entityData.Notes);
				this.entityData.Notes = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(WiscrColumn.Notes, this.entityData.Notes);
		...
		public virtual System.Int32 CreateUserId
		{
			...
			set
			{
				...
				OnColumnChanging(WiscrColumn.CreateUserId, this.entityData.CreateUserId);
				this.entityData.CreateUserId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(WiscrColumn.CreateUserId, this.entityData.CreateUserId);
		...
		public virtual System.Int32? UpdateUserId
		{
			...
			set
			{
				...
				OnColumnChanging(WiscrColumn.UpdateUserId, this.entityData.UpdateUserId);
				this.entityData.UpdateUserId = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(WiscrColumn.UpdateUserId, this.entityData.UpdateUserId);
		...
		public virtual System.Boolean Active
		{
			...
			set
			{
				...
				OnColumnChanging(WiscrColumn.Active, this.entityData.Active);
				this.entityData.Active = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(WiscrColumn.Active, this.entityData.Active);
		...
		public virtual System.Boolean Deleted
		{
			...
			set
			{
				...
				OnColumnChanging(WiscrColumn.Deleted, this.entityData.Deleted);
				this.entityData.Deleted = value;
				if ( !this._deserializing && this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(WiscrColumn.Deleted, this.entityData.Deleted);
...
/*
        ...
        public int CompareTo(Wiscr rhs, WiscrColumn which)
        {
            switch (which)
            {
            	...
            	case WiscrColumn.CubesPatternRawScore:
            		return this.CubesPatternRawScore.Value.CompareTo(rhs.CubesPatternRawScore.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{38}{37}- WiscrId: {0}{37}- SeanceId: {1}{37}- GeneralRawScore: {2}{37}- GeneralStandartScore: {3}{37}- SimilarityRawScore: {4}{37}- SimilarityStandartScore: {5}{37}- ArithmeticRawScore: {6}{37}- ArithmeticStandartScore: {7}{37}- WordRawScore: {8}{37}- WordStandartScore: {9}{37}- JudgingRawScore: {10}{37}- JudgingStandartScore: {11}{37}- SetOfNumbersRawScore: {12}{37}- SetOfNumbersStandartScore: {13}{37}- ImageDefineRawScore: {14}{37}- ImageDefineStandartScore: {15}{37}- ImageEditingRawScore: {16}{37}- ImageEditingStandartScore: {17}{37}- CubesPatternRawScore: {18}{37}- CubesPatternStandartScore: {19}{37}- PartsMergeRawScore: {20}{37}- PartsMergeStandartScore: {21}{37}- PasswordRawScore: {22}{37}- PasswordStandartScore: {23}{37}- MazesRawScore: {24}{37}- MazesStandartScore: {25}{37}- TotalVerbalScore: {26}{37}- TotalPerformanceScore: {27}{37}- TotalScore: {28}{37}- Notes: {29}{37}- TestDate: {30}{37}- CreateDate: {31}{37}- UpdateDate: {32}{37}- CreateUserId: {33}{37}- UpdateUserId: {34}{37}- Active: {35}{37}- Deleted: {36}{37}{39}", 
				this.WiscrId,
	...
	internal protected class WiscrEntityData : ICloneable, ICloneableEx
	{
		...
		/// </summary>
		[DataMember]
		public System.Int32? CubesPatternRawScore = null;
	...
	public enum WiscrColumn : int
	{
		...
		ImageEditingStandartScore = 18,
		/// <summary>
		/// CubesPatternRawScore : 
		/// </summary>
		[EnumTextValue("Cubes Pattern Raw Score")]
		[ColumnEnum("CubesPatternRawScore", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		CubesPatternRawScore = 19,
		/// <summary>
		/// CubesPatternStandartScore : 
		/// </summary>
