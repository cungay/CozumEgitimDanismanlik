...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ClientFatherTest"/> instance.
		/// </summary>	
		public ClientFatherTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ClientFather objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ClientFather CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ClientFather mock = ClientFatherTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ClientFather mock)
        {
            ClientFatherTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ClientFather mock)
        {
