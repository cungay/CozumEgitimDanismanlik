   ...
   public partial class ClientFatherTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				if(mock.OtherPhone != null)
					query.AppendEquals(ClientFatherColumn.OtherPhone, mock.OtherPhone.ToString());
				if(mock.JobId != null)
				...
				query.AppendEquals(ClientFatherColumn.FatherStatusId, mock.FatherStatusId.ToString());
				query.AppendEquals(ClientFatherColumn.CreateDate, mock.CreateDate.ToString());
				if(mock.UpdateDate != null)
					query.AppendEquals(ClientFatherColumn.UpdateDate, mock.UpdateDate.ToString());
				query.AppendEquals(ClientFatherColumn.CreateUserId, mock.CreateUserId.ToString());
				if(mock.UpdateUserId != null)
					query.AppendEquals(ClientFatherColumn.UpdateUserId, mock.UpdateUserId.ToString());
				query.AppendEquals(ClientFatherColumn.Active, mock.Active.ToString());
				query.AppendEquals(ClientFatherColumn.Deleted, mock.Deleted.ToString());
		...
		{		
			...
			mock.OtherPhone = TestUtility.Instance.RandomString(24, false);;
			mock.JobId = TestUtility.Instance.RandomNumber();
			mock.Notes = TestUtility.Instance.RandomString(249, false);;
			mock.FatherStatusId = TestUtility.Instance.RandomByte();
