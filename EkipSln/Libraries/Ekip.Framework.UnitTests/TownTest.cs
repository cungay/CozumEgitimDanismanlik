...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TownTest"/> instance.
		/// </summary>	
		public TownTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Town objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Town CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Town mock = TownTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Town mock)
        {
            TownTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Town mock)
        {
