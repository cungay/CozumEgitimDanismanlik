...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="NeighborhoodTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  Neighborhood objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Neighborhood CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Neighborhood mock = NeighborhoodTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Neighborhood mock)
        {
            NeighborhoodTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Neighborhood mock)
        {
