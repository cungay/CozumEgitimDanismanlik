...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="JobTest"/> instance.
		/// </summary>	
		public JobTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Job objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Job CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Job mock = JobTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Job mock)
        {
            JobTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Job mock)
        {
