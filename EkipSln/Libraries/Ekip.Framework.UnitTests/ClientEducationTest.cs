...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ClientEducationTest"/> instance.
		/// </summary>	
		public ClientEducationTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ClientEducation objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ClientEducation CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ClientEducation mock = ClientEducationTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ClientEducation mock)
        {
            ClientEducationTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ClientEducation mock)
        {
