...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ClientMotherTest"/> instance.
		/// </summary>	
		public ClientMotherTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ClientMother objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ClientMother CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ClientMother mock = ClientMotherTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ClientMother mock)
        {
            ClientMotherTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ClientMother mock)
        {
