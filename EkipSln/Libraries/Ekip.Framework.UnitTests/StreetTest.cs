...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="StreetTest"/> instance.
		/// </summary>	
		public StreetTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Street objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Street CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Street mock = StreetTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Street mock)
        {
            StreetTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Street mock)
        {
