...
{
    /// <summary>
    /// Provides tests for the <see cref="ProvinceView"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ProvinceViewTest"/> instance.
		/// </summary>	
		public ProvinceViewTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ProvinceView objects of the database.
		/// </summary>
