...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ClientAddressTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  ClientAddress objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ClientAddress CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ClientAddress mock = ClientAddressTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ClientAddress mock)
        {
            ClientAddressTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ClientAddress mock)
        {
