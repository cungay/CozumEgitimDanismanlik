...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="WiscrTest"/> instance.
		/// </summary>	
		public WiscrTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Wiscr objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Wiscr CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Wiscr mock = WiscrTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Wiscr mock)
        {
            WiscrTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Wiscr mock)
        {
