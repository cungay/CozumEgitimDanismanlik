...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ObservationFormGroupTest"/> instance.
		/// </summary>	
		public ObservationFormGroupTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ObservationFormGroup objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ObservationFormGroup CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ObservationFormGroup mock = ObservationFormGroupTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ObservationFormGroup mock)
        {
            ObservationFormGroupTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ObservationFormGroup mock)
        {
