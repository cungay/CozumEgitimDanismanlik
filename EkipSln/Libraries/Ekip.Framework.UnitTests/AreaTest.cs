...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="AreaTest"/> instance.
		/// </summary>	
		public AreaTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Area objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Area CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Area mock = AreaTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Area mock)
        {
            AreaTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Area mock)
        {
