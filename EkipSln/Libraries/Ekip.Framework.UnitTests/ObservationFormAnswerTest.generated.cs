   ...
   public partial class ObservationFormAnswerTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				query.AppendEquals(ObservationFormAnswerColumn.CreateDate, mock.CreateDate.ToString());
				if(mock.UpdateDate != null)
					query.AppendEquals(ObservationFormAnswerColumn.UpdateDate, mock.UpdateDate.ToString());
				query.AppendEquals(ObservationFormAnswerColumn.CreateUserId, mock.CreateUserId.ToString());
				if(mock.UpdateUserId != null)
					query.AppendEquals(ObservationFormAnswerColumn.UpdateUserId, mock.UpdateUserId.ToString());
				query.AppendEquals(ObservationFormAnswerColumn.Active, mock.Active.ToString());
				query.AppendEquals(ObservationFormAnswerColumn.Deleted, mock.Deleted.ToString());
