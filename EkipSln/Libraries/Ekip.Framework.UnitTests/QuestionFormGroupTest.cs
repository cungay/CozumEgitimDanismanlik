...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="QuestionFormGroupTest"/> instance.
		/// </summary>	
		public QuestionFormGroupTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  QuestionFormGroup objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public QuestionFormGroup CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            QuestionFormGroup mock = QuestionFormGroupTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, QuestionFormGroup mock)
        {
            QuestionFormGroupTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(QuestionFormGroup mock)
        {
