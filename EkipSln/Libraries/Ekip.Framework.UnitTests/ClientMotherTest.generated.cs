   ...
   public partial class ClientMotherTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				if(mock.OtherPhone != null)
					query.AppendEquals(ClientMotherColumn.OtherPhone, mock.OtherPhone.ToString());
				if(mock.JobId != null)
				...
				query.AppendEquals(ClientMotherColumn.MotherStatusId, mock.MotherStatusId.ToString());
		...
		{		
			...
			mock.MotherStatusId = TestUtility.Instance.RandomByte();
