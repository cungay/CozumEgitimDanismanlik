...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SeanceReasonTest"/> instance.
		/// </summary>	
		public SeanceReasonTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SeanceReason objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SeanceReason CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SeanceReason mock = SeanceReasonTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SeanceReason mock)
        {
            SeanceReasonTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(SeanceReason mock)
        {
