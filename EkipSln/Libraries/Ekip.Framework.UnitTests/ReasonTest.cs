...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ReasonTest"/> instance.
		/// </summary>	
		public ReasonTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Reason objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Reason CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Reason mock = ReasonTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Reason mock)
        {
            ReasonTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Reason mock)
        {
