...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		...
		/// <summary>
		/// Selects a sample of  Session objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Session CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Session mock = SessionTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Session mock)
        {
            SessionTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Session mock)
        {
