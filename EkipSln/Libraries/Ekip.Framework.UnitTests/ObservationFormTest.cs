...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ObservationFormTest"/> instance.
		/// </summary>	
		public ObservationFormTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ObservationForm objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ObservationForm CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ObservationForm mock = ObservationFormTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ObservationForm mock)
        {
            ObservationFormTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ObservationForm mock)
        {
