...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ClientTest"/> instance.
		/// </summary>	
		public ClientTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Client objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Client CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Client mock = ClientTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Client mock)
        {
            ClientTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Client mock)
        {
