...
AND so.name <> 'NeighborhoodView_GetByNeighborhoodId'
AND so.name <> 'NeighborhoodView_GetByTownId'
AND so.name <> 'StreetView_GetByNeighborhoodId'
AND so.name <> 'StreetView_GetByStreetId'
AND so.name <> 'TownView_GetByProvinceId'
AND so.name <> 'TownView_GetByTownId'
OPEN c
...
/*
----------------------------------------------------------------------------------------------------
-- Date Created: 18 Haziran 2019 Salı
...
-- Drop the dbo.sp_CalendarAge_Get_List procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_CalendarAge_Get_List') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_CalendarAge_Get_List
GO
...
CREATE PROCEDURE dbo.sp_CalendarAge_Get_List
...
-- Drop the dbo.sp_CalendarAge_GetPaged procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_CalendarAge_GetPaged') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_CalendarAge_GetPaged
GO
...
CREATE PROCEDURE dbo.sp_CalendarAge_GetPaged
(
...
-- Drop the dbo.sp_CalendarAge_Insert procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_CalendarAge_Insert') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_CalendarAge_Insert
GO
...
CREATE PROCEDURE dbo.sp_CalendarAge_Insert
(

	@CalendarAgeId int    OUTPUT,
...
-- Drop the dbo.sp_CalendarAge_Update procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_CalendarAge_Update') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_CalendarAge_Update
GO
...
CREATE PROCEDURE dbo.sp_CalendarAge_Update
(
...
-- Drop the dbo.sp_CalendarAge_Delete procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_CalendarAge_Delete') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_CalendarAge_Delete
GO
...
CREATE PROCEDURE dbo.sp_CalendarAge_Delete
(
...
-- Drop the dbo.sp_CalendarAge_GetByCalendarAgeId procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_CalendarAge_GetByCalendarAgeId') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_CalendarAge_GetByCalendarAgeId
GO
...
CREATE PROCEDURE dbo.sp_CalendarAge_GetByCalendarAgeId
(
...
-- Drop the dbo.sp_CalendarAge_Find procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_CalendarAge_Find') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_CalendarAge_Find
GO
...
CREATE PROCEDURE dbo.sp_CalendarAge_Find
(

	@SearchUsingOR bit   = null ,

	@CalendarAgeId int   = null ,

	@AgeDescription varchar (50)  = null ,
...
-- Drop the dbo.sp_NeighborhoodView_Get_List procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_NeighborhoodView_Get_List') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_NeighborhoodView_Get_List
GO
...
CREATE PROCEDURE dbo.sp_NeighborhoodView_Get_List
...
-- Drop the dbo.sp_NeighborhoodView_Get procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_NeighborhoodView_Get') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_NeighborhoodView_Get
GO
...
CREATE PROCEDURE dbo.sp_NeighborhoodView_Get
(
...
AS
                    ...
                    SET @SQL = @SQL + ', [NeighborhoodId]'
                    SET @SQL = @SQL + ', [NeighborhoodName]'
                    SET @SQL = @SQL + ' FROM [dbo].[NeighborhoodView]'
                    IF LEN(@WhereClause) > 0
                    BEGIN
                        SET @SQL = @SQL + ' WHERE ' + @WhereClause
                    END
...
-- Drop the dbo.sp_StreetView_Get_List procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_StreetView_Get_List') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_StreetView_Get_List
GO
...
CREATE PROCEDURE dbo.sp_StreetView_Get_List
...
-- Drop the dbo.sp_StreetView_Get procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_StreetView_Get') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_StreetView_Get
GO
...
CREATE PROCEDURE dbo.sp_StreetView_Get
(
...
AS
                    ...
                    SET @SQL = @SQL + ', [StreetName]'
                    SET @SQL = @SQL + ', [ZipCode]'
                    SET @SQL = @SQL + ' FROM [dbo].[StreetView]'
                    IF LEN(@WhereClause) > 0
                    BEGIN
                        SET @SQL = @SQL + ' WHERE ' + @WhereClause
                    END
...
-- Drop the dbo.sp_TownView_Get_List procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_TownView_Get_List') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_TownView_Get_List
GO
...
CREATE PROCEDURE dbo.sp_TownView_Get_List
...
-- Drop the dbo.sp_TownView_Get procedure
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id(N'dbo.sp_TownView_Get') AND OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE dbo.sp_TownView_Get
GO
...
CREATE PROCEDURE dbo.sp_TownView_Get
(
