   ...
   public partial class WiscrTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				query.AppendEquals(WiscrColumn.UserId, mock.UserId.ToString());
				if(mock.AdvisorId != null)
					query.AppendEquals(WiscrColumn.AdvisorId, mock.AdvisorId.ToString());
		...
		{		
			...
			mock.CubesPatternRawScore = TestUtility.Instance.RandomString(10, false);;
