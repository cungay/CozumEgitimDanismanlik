   ...
   public partial class ClientMotherTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				query.AppendEquals(ClientMotherColumn.StatusId, mock.StatusId.ToString());
				if(mock.Notes != null)
					query.AppendEquals(ClientMotherColumn.Notes, mock.Notes.ToString());
				query.AppendEquals(ClientMotherColumn.CreateOn, mock.CreateOn.ToString());
				if(mock.UpdateOn != null)
					query.AppendEquals(ClientMotherColumn.UpdateOn, mock.UpdateOn.ToString());
				query.AppendEquals(ClientMotherColumn.UserId, mock.UserId.ToString());
		...
		{		
			...
			mock.StatusId = TestUtility.Instance.RandomNumber();
