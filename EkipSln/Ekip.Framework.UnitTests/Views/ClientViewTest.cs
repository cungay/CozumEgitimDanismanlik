...
{
    /// <summary>
    /// Provides tests for the <see cref="ClientView"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ClientViewTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects all ClientView objects of the database.
		/// </summary>
