...
{
    /// <summary>
    /// Provides tests for the <see cref="WiscrView"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="WiscrViewTest"/> instance.
		/// </summary>	
		public WiscrViewTest()
		{			
		}
		...
		/// <summary>
		/// Selects all WiscrView objects of the database.
		/// </summary>
