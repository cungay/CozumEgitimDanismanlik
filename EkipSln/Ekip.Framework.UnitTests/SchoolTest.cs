...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SchoolTest"/> instance.
		/// </summary>	
		public SchoolTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  School objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public School CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            School mock = SchoolTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, School mock)
        {
            SchoolTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(School mock)
        {
