...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TeacherTest"/> instance.
		/// </summary>	
		public TeacherTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Teacher objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Teacher CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Teacher mock = TeacherTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Teacher mock)
        {
            TeacherTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Teacher mock)
        {
