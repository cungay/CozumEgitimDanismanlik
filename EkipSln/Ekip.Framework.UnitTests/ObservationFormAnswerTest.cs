...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ObservationFormAnswerTest"/> instance.
		/// </summary>	
		public ObservationFormAnswerTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ObservationFormAnswer objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ObservationFormAnswer CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ObservationFormAnswer mock = ObservationFormAnswerTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ObservationFormAnswer mock)
        {
            ObservationFormAnswerTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ObservationFormAnswer mock)
        {
