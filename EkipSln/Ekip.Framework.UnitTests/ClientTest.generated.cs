   ...
   public partial class ClientTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				if(mock.Age != null)
					query.AppendEquals(ClientColumn.Age, mock.Age.ToString());
				...
				query.AppendEquals(ClientColumn.CreateOn, mock.CreateOn.ToString());
				if(mock.UpdateOn != null)
					query.AppendEquals(ClientColumn.UpdateOn, mock.UpdateOn.ToString());
				query.AppendEquals(ClientColumn.UserId, mock.UserId.ToString());
