   ...
   public partial class StreetTest
    {
		...
		private void Step_11_IX_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				Street t1 = DataRepository.StreetProvider.GetById(tm, entity.Id);
			}
		}
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				query.AppendEquals(StreetColumn.Id, mock.Id.ToString());
		...
		{		
			...
			mock.NeighborhoodId = mockNeighborhoodByNeighborhoodId.Id;
