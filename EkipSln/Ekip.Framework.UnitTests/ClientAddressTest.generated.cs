   ...
   public partial class ClientAddressTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				query.AppendEquals(ClientAddressColumn.IsUsed, mock.IsUsed.ToString());
				query.AppendEquals(ClientAddressColumn.CreateOn, mock.CreateOn.ToString());
				if(mock.UpdateOn != null)
					query.AppendEquals(ClientAddressColumn.UpdateOn, mock.UpdateOn.ToString());
				query.AppendEquals(ClientAddressColumn.UserId, mock.UserId.ToString());
		...
		{		
			...
			mock.IsUsed = TestUtility.Instance.RandomBoolean();
