...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SeanceQuestionTest"/> instance.
		/// </summary>	
		public SeanceQuestionTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SeanceQuestion objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SeanceQuestion CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SeanceQuestion mock = SeanceQuestionTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SeanceQuestion mock)
        {
            SeanceQuestionTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(SeanceQuestion mock)
        {
