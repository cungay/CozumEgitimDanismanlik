...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="QuestionFormAnswerTest"/> instance.
		/// </summary>	
		public QuestionFormAnswerTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  QuestionFormAnswer objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public QuestionFormAnswer CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            QuestionFormAnswer mock = QuestionFormAnswerTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, QuestionFormAnswer mock)
        {
            QuestionFormAnswerTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(QuestionFormAnswer mock)
        {
