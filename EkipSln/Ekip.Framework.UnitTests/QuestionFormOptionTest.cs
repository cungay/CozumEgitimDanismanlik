...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="QuestionFormOptionTest"/> instance.
		/// </summary>	
		public QuestionFormOptionTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  QuestionFormOption objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public QuestionFormOption CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            QuestionFormOption mock = QuestionFormOptionTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, QuestionFormOption mock)
        {
            QuestionFormOptionTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(QuestionFormOption mock)
        {
