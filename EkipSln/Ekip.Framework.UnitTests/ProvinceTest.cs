...
namespace Ekip.Framework.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProvinceTest"/> instance.
		/// </summary>	
		public ProvinceTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Province objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Province CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Province mock = ProvinceTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Province mock)
        {
            ProvinceTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Province mock)
        {
