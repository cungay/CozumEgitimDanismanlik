...
{	
	...
	{		
		...
		public Ekip.Framework.Entities.ClientDoc GetByFileId(System.Int32 _fileId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.ClientDoc"/> class.</returns>
		public Ekip.Framework.Entities.ClientDoc GetByFileId(System.Int32 _fileId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.ClientDoc"/> class.</returns>
		public Ekip.Framework.Entities.ClientDoc GetByFileId(TransactionManager transactionManager, System.Int32 _fileId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.ClientDoc"/> class.</returns>
		public Ekip.Framework.Entities.ClientDoc GetByFileId(TransactionManager transactionManager, System.Int32 _fileId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.ClientDoc"/> class.</returns>
		public Ekip.Framework.Entities.ClientDoc GetByFileId(System.Int32 _fileId, int start, int pageLength, out int count)
		{
			return GetByFileId(null, _fileId, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.ClientDoc"/> class.</returns>
		public abstract Ekip.Framework.Entities.ClientDoc GetByFileId(TransactionManager transactionManager, System.Int32 _fileId, int start, int pageLength, out int count);
		...
		public static TList<ClientDoc> Fill(IDataReader reader, TList<ClientDoc> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int32)reader[((int)ClientDocColumn.FileId - 1)]).ToString();
					...
					))
				{
					...
					c.FileId = (System.Int32)reader[((int)ClientDocColumn.FileId - 1)];
					...
					c.CreateOn = (System.DateTime)reader[((int)ClientDocColumn.CreateOn - 1)];
					c.UpdateOn = (reader.IsDBNull(((int)ClientDocColumn.UpdateOn - 1)))?null:(System.DateTime?)reader[((int)ClientDocColumn.UpdateOn - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.ClientDoc entity)
		{
			...
			entity.FileId = (System.Int32)reader[((int)ClientDocColumn.FileId - 1)];
			...
			entity.CreateOn = (System.DateTime)reader[((int)ClientDocColumn.CreateOn - 1)];
			entity.UpdateOn = (reader.IsDBNull(((int)ClientDocColumn.UpdateOn - 1)))?null:(System.DateTime?)reader[((int)ClientDocColumn.UpdateOn - 1)];
