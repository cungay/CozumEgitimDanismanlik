...
{	
	...
	{		
		...
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Province"/> class.</returns>
		public Ekip.Framework.Entities.Province GetById(System.Int32 _ıd)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Province"/> class.</returns>
		public Ekip.Framework.Entities.Province GetById(System.Int32 _ıd, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Province"/> class.</returns>
		public Ekip.Framework.Entities.Province GetById(TransactionManager transactionManager, System.Int32 _ıd)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Province"/> class.</returns>
		public Ekip.Framework.Entities.Province GetById(TransactionManager transactionManager, System.Int32 _ıd, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Province"/> class.</returns>
		public Ekip.Framework.Entities.Province GetById(System.Int32 _ıd, int start, int pageLength, out int count)
		{
			return GetById(null, _ıd, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Province"/> class.</returns>
		public abstract Ekip.Framework.Entities.Province GetById(TransactionManager transactionManager, System.Int32 _ıd, int start, int pageLength, out int count);
		...
		public static TList<Province> Fill(IDataReader reader, TList<Province> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int32)reader[((int)ProvinceColumn.Id - 1)]).ToString();
					...
					))
				{
					...
					c.Id = (System.Int32)reader[((int)ProvinceColumn.Id - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Province entity)
		{
			...
			entity.Id = (System.Int32)reader[((int)ProvinceColumn.Id - 1)];
		...
		public override void DeepLoad(TransactionManager transactionManager, Ekip.Framework.Entities.Province entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			...
			if (CanDeepLoad(entity, "List<Town>|TownCollection", deepLoadType, innerList)) 
			{
				...
				entity.TownCollection = DataRepository.TownProvider.GetByProvinceId(transactionManager, entity.Id);
			...
			#region List<Town>
				...
				{	
					...
					foreach(Town child in entity.TownCollection)
					{
						...
						{
							child.ProvinceId = child.ProvinceIdSource.Id;
						}
						else
						{
							child.ProvinceId = entity.Id;
						}
