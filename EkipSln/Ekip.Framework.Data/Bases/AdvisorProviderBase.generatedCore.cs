...
{	
	...
	{		
		...
		public static TList<Advisor> Fill(IDataReader reader, TList<Advisor> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.Title = (reader.IsDBNull(((int)AdvisorColumn.Title - 1)))?null:(System.String)reader[((int)AdvisorColumn.Title - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Advisor entity)
		{
			...
			entity.Title = (reader.IsDBNull(((int)AdvisorColumn.Title - 1)))?null:(System.String)reader[((int)AdvisorColumn.Title - 1)];
