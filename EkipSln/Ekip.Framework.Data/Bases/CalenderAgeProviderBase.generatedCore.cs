...
{	
	...
	{		
		...
		public Ekip.Framework.Entities.CalenderAge GetById(System.Int32 _ıd)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.CalenderAge"/> class.</returns>
		public Ekip.Framework.Entities.CalenderAge GetById(System.Int32 _ıd, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.CalenderAge"/> class.</returns>
		public Ekip.Framework.Entities.CalenderAge GetById(TransactionManager transactionManager, System.Int32 _ıd)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.CalenderAge"/> class.</returns>
		public Ekip.Framework.Entities.CalenderAge GetById(TransactionManager transactionManager, System.Int32 _ıd, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.CalenderAge"/> class.</returns>
		public Ekip.Framework.Entities.CalenderAge GetById(System.Int32 _ıd, int start, int pageLength, out int count)
		{
			return GetById(null, _ıd, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.CalenderAge"/> class.</returns>
		public abstract Ekip.Framework.Entities.CalenderAge GetById(TransactionManager transactionManager, System.Int32 _ıd, int start, int pageLength, out int count);
		...
		public static TList<CalenderAge> Fill(IDataReader reader, TList<CalenderAge> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int32)reader[((int)CalenderAgeColumn.Id - 1)]).ToString();
					...
					))
				{
					...
					c.Id = (System.Int32)reader[((int)CalenderAgeColumn.Id - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.CalenderAge entity)
		{
			...
			entity.Id = (System.Int32)reader[((int)CalenderAgeColumn.Id - 1)];
