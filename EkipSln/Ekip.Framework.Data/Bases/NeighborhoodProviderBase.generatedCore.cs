...
{	
	...
	{		
		...
		public Ekip.Framework.Entities.Neighborhood GetById(System.Int32 _ıd)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Neighborhood"/> class.</returns>
		public Ekip.Framework.Entities.Neighborhood GetById(System.Int32 _ıd, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Neighborhood"/> class.</returns>
		public Ekip.Framework.Entities.Neighborhood GetById(TransactionManager transactionManager, System.Int32 _ıd)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Neighborhood"/> class.</returns>
		public Ekip.Framework.Entities.Neighborhood GetById(TransactionManager transactionManager, System.Int32 _ıd, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Neighborhood"/> class.</returns>
		public Ekip.Framework.Entities.Neighborhood GetById(System.Int32 _ıd, int start, int pageLength, out int count)
		{
			return GetById(null, _ıd, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Neighborhood"/> class.</returns>
		public abstract Ekip.Framework.Entities.Neighborhood GetById(TransactionManager transactionManager, System.Int32 _ıd, int start, int pageLength, out int count);
		...
		public static TList<Neighborhood> Fill(IDataReader reader, TList<Neighborhood> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int32)reader[((int)NeighborhoodColumn.Id - 1)]).ToString();
					...
					))
				{
					...
					c.Id = (System.Int32)reader[((int)NeighborhoodColumn.Id - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Neighborhood entity)
		{
			...
			entity.Id = (System.Int32)reader[((int)NeighborhoodColumn.Id - 1)];
		...
		public override void DeepLoad(TransactionManager transactionManager, Ekip.Framework.Entities.Neighborhood entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
				...
				&& entity.TownIdSource == null)
			{
				...
				if (tmpEntity != null)
					...
					entity.TownIdSource = DataRepository.TownProvider.GetById(transactionManager, entity.TownId);		
			...
			if (CanDeepLoad(entity, "List<Street>|StreetCollection", deepLoadType, innerList)) 
			{
				...
				entity.StreetCollection = DataRepository.StreetProvider.GetByNeighborhoodId(transactionManager, entity.Id);
		...
		{	
				...
				&& entity.TownIdSource != null)
			{
				...
				entity.TownId = entity.TownIdSource.Id;
			}
			#endregion 
			...
			#region List<Street>
				...
				{	
					...
					foreach(Street child in entity.StreetCollection)
					{
						...
						{
							child.NeighborhoodId = child.NeighborhoodIdSource.Id;
						}
						else
						{
							child.NeighborhoodId = entity.Id;
						}
