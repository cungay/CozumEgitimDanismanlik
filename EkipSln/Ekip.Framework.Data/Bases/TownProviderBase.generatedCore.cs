...
{	
	...
	{		
		...
		public Ekip.Framework.Entities.Town GetById(System.Int32 _ıd)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Town"/> class.</returns>
		public Ekip.Framework.Entities.Town GetById(System.Int32 _ıd, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Town"/> class.</returns>
		public Ekip.Framework.Entities.Town GetById(TransactionManager transactionManager, System.Int32 _ıd)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Town"/> class.</returns>
		public Ekip.Framework.Entities.Town GetById(TransactionManager transactionManager, System.Int32 _ıd, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Town"/> class.</returns>
		public Ekip.Framework.Entities.Town GetById(System.Int32 _ıd, int start, int pageLength, out int count)
		{
			return GetById(null, _ıd, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="Ekip.Framework.Entities.Town"/> class.</returns>
		public abstract Ekip.Framework.Entities.Town GetById(TransactionManager transactionManager, System.Int32 _ıd, int start, int pageLength, out int count);
		...
		public static TList<Town> Fill(IDataReader reader, TList<Town> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int32)reader[((int)TownColumn.Id - 1)]).ToString();
					...
					))
				{
					...
					c.Id = (System.Int32)reader[((int)TownColumn.Id - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Town entity)
		{
			...
			entity.Id = (System.Int32)reader[((int)TownColumn.Id - 1)];
		...
		public override void DeepLoad(TransactionManager transactionManager, Ekip.Framework.Entities.Town entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
				...
				&& entity.ProvinceIdSource == null)
			{
				...
				if (tmpEntity != null)
					...
					entity.ProvinceIdSource = DataRepository.ProvinceProvider.GetById(transactionManager, entity.ProvinceId);		
			...
			if (CanDeepLoad(entity, "List<Neighborhood>|NeighborhoodCollection", deepLoadType, innerList)) 
			{
				...
				entity.NeighborhoodCollection = DataRepository.NeighborhoodProvider.GetByTownId(transactionManager, entity.Id);
		...
		{	
				...
				&& entity.ProvinceIdSource != null)
			{
				...
				entity.ProvinceId = entity.ProvinceIdSource.Id;
			}
			#endregion 
			...
			#region List<Neighborhood>
				...
				{	
					...
					foreach(Neighborhood child in entity.NeighborhoodCollection)
					{
						...
						{
							child.TownId = child.TownIdSource.Id;
						}
						else
						{
							child.TownId = entity.Id;
						}
