...
{	
	...
	{		
		...
		public static TList<School> Fill(IDataReader reader, TList<School> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.InstitutionTypeId = (System.Byte)reader[((int)SchoolColumn.InstitutionTypeId - 1)];
					...
					c.SchoolNotes = (reader.IsDBNull(((int)SchoolColumn.SchoolNotes - 1)))?null:(System.String)reader[((int)SchoolColumn.SchoolNotes - 1)];
					c.CreateOn = (System.DateTime)reader[((int)SchoolColumn.CreateOn - 1)];
					c.UpdateOn = (reader.IsDBNull(((int)SchoolColumn.UpdateOn - 1)))?null:(System.DateTime?)reader[((int)SchoolColumn.UpdateOn - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.School entity)
		{
			...
			entity.InstitutionTypeId = (System.Byte)reader[((int)SchoolColumn.InstitutionTypeId - 1)];
			...
			entity.SchoolNotes = (reader.IsDBNull(((int)SchoolColumn.SchoolNotes - 1)))?null:(System.String)reader[((int)SchoolColumn.SchoolNotes - 1)];
			entity.CreateOn = (System.DateTime)reader[((int)SchoolColumn.CreateOn - 1)];
			entity.UpdateOn = (reader.IsDBNull(((int)SchoolColumn.UpdateOn - 1)))?null:(System.DateTime?)reader[((int)SchoolColumn.UpdateOn - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, Ekip.Framework.Entities.School entity)
		{
			...
			entity.InstitutionTypeId = (System.Byte)dataRow["InstitutionTypeId"];
			...
			entity.SchoolNotes = Convert.IsDBNull(dataRow["SchoolNotes"]) ? null : (System.String)dataRow["SchoolNotes"];
		...
		public override void DeepLoad(TransactionManager transactionManager, Ekip.Framework.Entities.School entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			...
			if (CanDeepLoad(entity, "List<ClientSchool>|ClientSchoolCollection", deepLoadType, innerList)) 
			{
				...
				entity.ClientSchoolCollection = DataRepository.ClientSchoolProvider.GetBySchoolId(transactionManager, entity.SchoolId);
	...
	public enum SchoolChildEntityTypes
	{
		...
		///<summary>
		/// Collection of <c>School</c> as OneToMany for ClientSchoolCollection
		///</summary>
