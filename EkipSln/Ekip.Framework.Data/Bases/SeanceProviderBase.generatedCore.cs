...
{	
	...
	{		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_Seance_Wippsi key.
		///		FK_Seance_Wippsi Description: 
		/// </summary>
		/// <param name="_wippsiId"></param>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public TList<Seance> GetByWippsiId(System.Int32? _wippsiId)
		{
			int count = -1;
			return GetByWippsiId(_wippsiId, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		/// <remarks></remarks>
		public TList<Seance> GetByWippsiId(TransactionManager transactionManager, System.Int32? _wippsiId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public TList<Seance> GetByWippsiId(TransactionManager transactionManager, System.Int32? _wippsiId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public TList<Seance> GetByWippsiId(System.Int32? _wippsiId, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public TList<Seance> GetByWippsiId(System.Int32? _wippsiId, int start, int pageLength,out int count)
		{
			return GetByWippsiId(null, _wippsiId, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public abstract TList<Seance> GetByWippsiId(TransactionManager transactionManager, System.Int32? _wippsiId, int start, int pageLength, out int count);
		
	
		/// <summary>
		/// 	Gets rows from the datasource based on the FK_Seance_Wiscr key.
		///		FK_Seance_Wiscr Description: 
		/// </summary>
		/// <param name="_wiscrId"></param>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public TList<Seance> GetByWiscrId(System.Int32? _wiscrId)
		{
			int count = -1;
			return GetByWiscrId(_wiscrId, 0,int.MaxValue, out count);
		}
		...
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		/// <remarks></remarks>
		public TList<Seance> GetByWiscrId(TransactionManager transactionManager, System.Int32? _wiscrId)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public TList<Seance> GetByWiscrId(TransactionManager transactionManager, System.Int32? _wiscrId, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public TList<Seance> GetByWiscrId(System.Int32? _wiscrId, int start, int pageLength)
		{
			int count =  -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public TList<Seance> GetByWiscrId(System.Int32? _wiscrId, int start, int pageLength,out int count)
		{
			return GetByWiscrId(null, _wiscrId, start, pageLength, out count);	
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns a typed collection of Ekip.Framework.Entities.Seance objects.</returns>
		public abstract TList<Seance> GetByWiscrId(TransactionManager transactionManager, System.Int32? _wiscrId, int start, int pageLength, out int count);
		...
		public static TList<Seance> Fill(IDataReader reader, TList<Seance> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.SeanceNotes = (reader.IsDBNull(((int)SeanceColumn.SeanceNotes - 1)))?null:(System.String)reader[((int)SeanceColumn.SeanceNotes - 1)];
					c.SeanceStatusId = (System.Byte)reader[((int)SeanceColumn.SeanceStatusId - 1)];
					c.WippsiId = (reader.IsDBNull(((int)SeanceColumn.WippsiId - 1)))?null:(System.Int32?)reader[((int)SeanceColumn.WippsiId - 1)];
					c.WiscrId = (reader.IsDBNull(((int)SeanceColumn.WiscrId - 1)))?null:(System.Int32?)reader[((int)SeanceColumn.WiscrId - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Seance entity)
		{
			...
			entity.SeanceNotes = (reader.IsDBNull(((int)SeanceColumn.SeanceNotes - 1)))?null:(System.String)reader[((int)SeanceColumn.SeanceNotes - 1)];
			entity.SeanceStatusId = (System.Byte)reader[((int)SeanceColumn.SeanceStatusId - 1)];
			entity.WippsiId = (reader.IsDBNull(((int)SeanceColumn.WippsiId - 1)))?null:(System.Int32?)reader[((int)SeanceColumn.WippsiId - 1)];
			entity.WiscrId = (reader.IsDBNull(((int)SeanceColumn.WiscrId - 1)))?null:(System.Int32?)reader[((int)SeanceColumn.WiscrId - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, Ekip.Framework.Entities.Seance entity)
		{
			...
			entity.SeanceNotes = Convert.IsDBNull(dataRow["SeanceNotes"]) ? null : (System.String)dataRow["SeanceNotes"];
			entity.SeanceStatusId = (System.Byte)dataRow["SeanceStatusId"];
			entity.WippsiId = Convert.IsDBNull(dataRow["WippsiId"]) ? null : (System.Int32?)dataRow["WippsiId"];
			entity.WiscrId = Convert.IsDBNull(dataRow["WiscrId"]) ? null : (System.Int32?)dataRow["WiscrId"];
		...
		public override void DeepLoad(TransactionManager transactionManager, Ekip.Framework.Entities.Seance entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			...
			#region WippsiIdSource	
			if (CanDeepLoad(entity, "Wippsi|WippsiIdSource", deepLoadType, innerList) 
				&& entity.WippsiIdSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.WippsiId ?? (int)0);
				Wippsi tmpEntity = EntityManager.LocateEntity<Wippsi>(EntityLocator.ConstructKeyFromPkItems(typeof(Wippsi), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.WippsiIdSource = tmpEntity;
				else
					entity.WippsiIdSource = DataRepository.WippsiProvider.GetByWippsiId(transactionManager, (entity.WippsiId ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'WippsiIdSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.WippsiIdSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.WippsiProvider.DeepLoad(transactionManager, entity.WippsiIdSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion WippsiIdSource

			#region WiscrIdSource	
			if (CanDeepLoad(entity, "Wiscr|WiscrIdSource", deepLoadType, innerList) 
				&& entity.WiscrIdSource == null)
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.WiscrId ?? (int)0);
				Wiscr tmpEntity = EntityManager.LocateEntity<Wiscr>(EntityLocator.ConstructKeyFromPkItems(typeof(Wiscr), pkItems), DataRepository.Provider.EnableEntityTracking);
				if (tmpEntity != null)
					entity.WiscrIdSource = tmpEntity;
				else
					entity.WiscrIdSource = DataRepository.WiscrProvider.GetByWiscrId(transactionManager, (entity.WiscrId ?? (int)0));		
				
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'WiscrIdSource' loaded. key " + entity.EntityTrackingKey);
				#endif 
				
				if (deep && entity.WiscrIdSource != null)
				{
					innerList.SkipChildren = true;
					DataRepository.WiscrProvider.DeepLoad(transactionManager, entity.WiscrIdSource, deep, deepLoadType, childTypes, innerList);
					innerList.SkipChildren = false;
				}
					
			}
			#endregion WiscrIdSource
		...
		{	
			...
			#region WippsiIdSource
			if (CanDeepSave(entity, "Wippsi|WippsiIdSource", deepSaveType, innerList) 
				&& entity.WippsiIdSource != null)
			{
				DataRepository.WippsiProvider.Save(transactionManager, entity.WippsiIdSource);
				entity.WippsiId = entity.WippsiIdSource.WippsiId;
			}
			#endregion 
			
			#region WiscrIdSource
			if (CanDeepSave(entity, "Wiscr|WiscrIdSource", deepSaveType, innerList) 
				&& entity.WiscrIdSource != null)
			{
				DataRepository.WiscrProvider.Save(transactionManager, entity.WiscrIdSource);
				entity.WiscrId = entity.WiscrIdSource.WiscrId;
			}
			#endregion 
	...
	public enum SeanceChildEntityTypes
	{
		...
		///<summary>
		/// Composite Property for <c>Wippsi</c> at WippsiIdSource
		///</summary>
		[ChildEntityType(typeof(Wippsi))]
		Wippsi,
			
		///<summary>
		/// Composite Property for <c>Wiscr</c> at WiscrIdSource
		///</summary>
		[ChildEntityType(typeof(Wiscr))]
		Wiscr,
