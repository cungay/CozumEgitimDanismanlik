...
{	
	...
	{		
		...
		public static TList<ClientFather> Fill(IDataReader reader, TList<ClientFather> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.StatusId = (System.Byte)reader[((int)ClientFatherColumn.StatusId - 1)];
					c.Notes = (reader.IsDBNull(((int)ClientFatherColumn.Notes - 1)))?null:(System.String)reader[((int)ClientFatherColumn.Notes - 1)];
					c.CreateOn = (System.DateTime)reader[((int)ClientFatherColumn.CreateOn - 1)];
					c.UpdateOn = (reader.IsDBNull(((int)ClientFatherColumn.UpdateOn - 1)))?null:(System.DateTime?)reader[((int)ClientFatherColumn.UpdateOn - 1)];
					c.UserId = (System.Int32)reader[((int)ClientFatherColumn.UserId - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.ClientFather entity)
		{
			...
			entity.StatusId = (System.Byte)reader[((int)ClientFatherColumn.StatusId - 1)];
			entity.Notes = (reader.IsDBNull(((int)ClientFatherColumn.Notes - 1)))?null:(System.String)reader[((int)ClientFatherColumn.Notes - 1)];
			entity.CreateOn = (System.DateTime)reader[((int)ClientFatherColumn.CreateOn - 1)];
			entity.UpdateOn = (reader.IsDBNull(((int)ClientFatherColumn.UpdateOn - 1)))?null:(System.DateTime?)reader[((int)ClientFatherColumn.UpdateOn - 1)];
			entity.UserId = (System.Int32)reader[((int)ClientFatherColumn.UserId - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, Ekip.Framework.Entities.ClientFather entity)
		{
			...
			entity.StatusId = (System.Byte)dataRow["StatusId"];
