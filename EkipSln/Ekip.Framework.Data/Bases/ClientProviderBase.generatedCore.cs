...
{	
	...
	{		
		...
		public IDataReader FindByReason_FirstDate_BirthDate(System.String seanceReasonIds, System.String firstContactYears, System.String birthDateYears)
		{
			return FindByReason_FirstDate_BirthDate(null, 0, int.MaxValue , seanceReasonIds, firstContactYears, birthDateYears);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader FindByReason_FirstDate_BirthDate(int start, int pageLength, System.String seanceReasonIds, System.String firstContactYears, System.String birthDateYears)
		{
			return FindByReason_FirstDate_BirthDate(null, start, pageLength , seanceReasonIds, firstContactYears, birthDateYears);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader FindByReason_FirstDate_BirthDate(TransactionManager transactionManager, System.String seanceReasonIds, System.String firstContactYears, System.String birthDateYears)
		{
			return FindByReason_FirstDate_BirthDate(transactionManager, 0, int.MaxValue , seanceReasonIds, firstContactYears, birthDateYears);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader FindByReason_FirstDate_BirthDate(TransactionManager transactionManager, int start, int pageLength , System.String seanceReasonIds, System.String firstContactYears, System.String birthDateYears);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader AdvisorReport(System.String advisorIds)
		{
			return AdvisorReport(null, 0, int.MaxValue , advisorIds);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader AdvisorReport(int start, int pageLength, System.String advisorIds)
		{
			return AdvisorReport(null, start, pageLength , advisorIds);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader AdvisorReport(TransactionManager transactionManager, System.String advisorIds)
		{
			return AdvisorReport(transactionManager, 0, int.MaxValue , advisorIds);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader AdvisorReport(TransactionManager transactionManager, int start, int pageLength , System.String advisorIds);
		...
		public static TList<Client> Fill(IDataReader reader, TList<Client> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.FirstContactDate = (reader.IsDBNull(((int)ClientColumn.FirstContactDate - 1)))?null:(System.DateTime?)reader[((int)ClientColumn.FirstContactDate - 1)];
					...
					c.MotherId = (reader.IsDBNull(((int)ClientColumn.MotherId - 1)))?null:(System.Int32?)reader[((int)ClientColumn.MotherId - 1)];
					c.FatherId = (reader.IsDBNull(((int)ClientColumn.FatherId - 1)))?null:(System.Int32?)reader[((int)ClientColumn.FatherId - 1)];
					...
					c.BirthDate = (reader.IsDBNull(((int)ClientColumn.BirthDate - 1)))?null:(System.DateTime?)reader[((int)ClientColumn.BirthDate - 1)];
					c.Age = (reader.IsDBNull(((int)ClientColumn.Age - 1)))?null:(System.Int32?)reader[((int)ClientColumn.Age - 1)];
					...
					c.CreateOn = (System.DateTime)reader[((int)ClientColumn.CreateOn - 1)];
					c.UpdateOn = (reader.IsDBNull(((int)ClientColumn.UpdateOn - 1)))?null:(System.DateTime?)reader[((int)ClientColumn.UpdateOn - 1)];
					c.UserId = (System.Int32)reader[((int)ClientColumn.UserId - 1)];
		...
		public static void RefreshEntity(IDataReader reader, Ekip.Framework.Entities.Client entity)
		{
			...
			entity.FirstContactDate = (reader.IsDBNull(((int)ClientColumn.FirstContactDate - 1)))?null:(System.DateTime?)reader[((int)ClientColumn.FirstContactDate - 1)];
			...
			entity.MotherId = (reader.IsDBNull(((int)ClientColumn.MotherId - 1)))?null:(System.Int32?)reader[((int)ClientColumn.MotherId - 1)];
			entity.FatherId = (reader.IsDBNull(((int)ClientColumn.FatherId - 1)))?null:(System.Int32?)reader[((int)ClientColumn.FatherId - 1)];
			...
			entity.BirthDate = (reader.IsDBNull(((int)ClientColumn.BirthDate - 1)))?null:(System.DateTime?)reader[((int)ClientColumn.BirthDate - 1)];
			entity.Age = (reader.IsDBNull(((int)ClientColumn.Age - 1)))?null:(System.Int32?)reader[((int)ClientColumn.Age - 1)];
			...
			entity.CreateOn = (System.DateTime)reader[((int)ClientColumn.CreateOn - 1)];
			entity.UpdateOn = (reader.IsDBNull(((int)ClientColumn.UpdateOn - 1)))?null:(System.DateTime?)reader[((int)ClientColumn.UpdateOn - 1)];
			entity.UserId = (System.Int32)reader[((int)ClientColumn.UserId - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, Ekip.Framework.Entities.Client entity)
		{
			...
			entity.FirstContactDate = Convert.IsDBNull(dataRow["FirstContactDate"]) ? null : (System.DateTime?)dataRow["FirstContactDate"];
			...
			entity.MotherId = Convert.IsDBNull(dataRow["MotherId"]) ? null : (System.Int32?)dataRow["MotherId"];
			entity.FatherId = Convert.IsDBNull(dataRow["FatherId"]) ? null : (System.Int32?)dataRow["FatherId"];
			...
			entity.Age = Convert.IsDBNull(dataRow["Age"]) ? null : (System.Int32?)dataRow["Age"];
		...
		public override void DeepLoad(TransactionManager transactionManager, Ekip.Framework.Entities.Client entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			...
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.FatherId ?? (int)0);
				...
				if (tmpEntity != null)
					...
					entity.FatherIdSource = DataRepository.ClientFatherProvider.GetByFatherId(transactionManager, (entity.FatherId ?? (int)0));		
			...
			{
				object[] pkItems = new object[1];
				pkItems[0] = (entity.MotherId ?? (int)0);
				...
				if (tmpEntity != null)
					...
					entity.MotherIdSource = DataRepository.ClientMotherProvider.GetByMotherId(transactionManager, (entity.MotherId ?? (int)0));		
			...
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<ClientSchool>|ClientSchoolCollection", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'ClientSchoolCollection' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.ClientSchoolCollection = DataRepository.ClientSchoolProvider.GetByClientId(transactionManager, entity.ClientId);

				if (deep && entity.ClientSchoolCollection.Count > 0)
				{
					deepHandles.Add("ClientSchoolCollection",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<ClientSchool>) DataRepository.ClientSchoolProvider.DeepLoad,
						new object[] { transactionManager, entity.ClientSchoolCollection, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
		...
		{	
			...
			#region List<ClientSchool>
				if (CanDeepSave(entity.ClientSchoolCollection, "List<ClientSchool>|ClientSchoolCollection", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(ClientSchool child in entity.ClientSchoolCollection)
					{
						if(child.ClientIdSource != null)
						{
							child.ClientId = child.ClientIdSource.ClientId;
					...
					if (entity.ClientSchoolCollection.Count > 0 || entity.ClientSchoolCollection.DeletedItems.Count > 0)
					{
						//DataRepository.ClientSchoolProvider.Save(transactionManager, entity.ClientSchoolCollection);
						
						deepHandles.Add("ClientSchoolCollection",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< ClientSchool >) DataRepository.ClientSchoolProvider.DeepSave,
							new object[] { transactionManager, entity.ClientSchoolCollection, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	public enum ClientChildEntityTypes
	{
		...
		///<summary>
		/// Collection of <c>Client</c> as OneToMany for ClientSchoolCollection
		///</summary>
		[ChildEntityType(typeof(TList<ClientSchool>))]
		ClientSchoolCollection,
	}
