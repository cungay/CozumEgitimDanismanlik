...
namespace Ekip.Framework.Data
{
	...
	public sealed class DataRepository 
	{
		...
		#region ClientDocProvider

		///<summary>
		/// Gets the current instance of the Data Access Logic Component for the <see cref="ClientDoc"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		public static ClientDocProviderBase ClientDocProvider
		{
			get 
			{
				LoadProviders();
				return _provider.ClientDocProvider;
			}
		}
		
		#endregion
		
		#region ClientSchoolProvider

		///<summary>
		/// Gets the current instance of the Data Access Logic Component for the <see cref="ClientSchool"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		public static ClientSchoolProviderBase ClientSchoolProvider
		{
			get 
			{
				LoadProviders();
				return _provider.ClientSchoolProvider;
			}
		}
		...
		#region ClientViewProvider
		
		///<summary>
		/// Gets the current instance of the Data Access Logic Component for the <see cref="ClientView"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		public static ClientViewProviderBase ClientViewProvider
		{
			get 
			{
				LoadProviders();
				return _provider.ClientViewProvider;
			}
		}
		...
		#region WippsiViewProvider
		
		///<summary>
		/// Gets the current instance of the Data Access Logic Component for the <see cref="WippsiView"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		public static WippsiViewProviderBase WippsiViewProvider
		{
			get 
			{
				LoadProviders();
				return _provider.WippsiViewProvider;
			}
		}
		
		#endregion
		
		#region WiscrViewProvider
		
		///<summary>
		/// Gets the current instance of the Data Access Logic Component for the <see cref="WiscrView"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		public static WiscrViewProviderBase WiscrViewProvider
		{
			get 
			{
				LoadProviders();
				return _provider.WiscrViewProvider;
			}
		}
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ClientDocFilters : ClientDocFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ClientDocFilters class.
		/// </summary>
		public ClientDocFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the ClientDocFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ClientDocFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ClientDocFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ClientDocFilters
	
	#region ClientDocQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ClientDocParameterBuilder"/> class
	/// that is used exclusively with a <see cref="ClientDoc"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class ClientDocQuery : ClientDocParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ClientDocQuery class.
		/// </summary>
		public ClientDocQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the ClientDocQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ClientDocQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ClientDocQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ClientDocQuery
		
	#region ClientSchoolFilters
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ClientSchoolFilters : ClientSchoolFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ClientSchoolFilters class.
		/// </summary>
		public ClientSchoolFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the ClientSchoolFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ClientSchoolFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ClientSchoolFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ClientSchoolFilters
	
	#region ClientSchoolQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ClientSchoolParameterBuilder"/> class
	/// that is used exclusively with a <see cref="ClientSchool"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class ClientSchoolQuery : ClientSchoolParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ClientSchoolQuery class.
		/// </summary>
		public ClientSchoolQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the ClientSchoolQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ClientSchoolQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ClientSchoolQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ClientSchoolQuery
	...
	/// </summary>
	[CLSCompliant(true)]
	public class ClientViewFilters : ClientViewFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ClientViewFilters class.
		/// </summary>
		public ClientViewFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the ClientViewFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ClientViewFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ClientViewFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ClientViewFilters
	
	#region ClientViewQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="ClientViewParameterBuilder"/> class
	/// that is used exclusively with a <see cref="ClientView"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class ClientViewQuery : ClientViewParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the ClientViewQuery class.
		/// </summary>
		public ClientViewQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the ClientViewQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public ClientViewQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public ClientViewQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion ClientViewQuery
	...
	/// </summary>
	[CLSCompliant(true)]
	public class WippsiViewFilters : WippsiViewFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the WippsiViewFilters class.
		/// </summary>
		public WippsiViewFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the WippsiViewFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public WippsiViewFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public WippsiViewFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion WippsiViewFilters
	
	#region WippsiViewQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="WippsiViewParameterBuilder"/> class
	/// that is used exclusively with a <see cref="WippsiView"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class WippsiViewQuery : WippsiViewParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the WippsiViewQuery class.
		/// </summary>
		public WippsiViewQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the WippsiViewQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public WippsiViewQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public WippsiViewQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion WippsiViewQuery
		
	#region WiscrViewFilters
	...
	/// </summary>
	[CLSCompliant(true)]
	public class WiscrViewFilters : WiscrViewFilterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the WiscrViewFilters class.
		/// </summary>
		public WiscrViewFilters() : base() { }

		/// <summary>
		/// Initializes a new instance of the WiscrViewFilters class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public WiscrViewFilters(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public WiscrViewFilters(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion WiscrViewFilters
	
	#region WiscrViewQuery
	
	/// <summary>
	/// A strongly-typed instance of the <see cref="WiscrViewParameterBuilder"/> class
	/// that is used exclusively with a <see cref="WiscrView"/> object.
	/// </summary>
	[CLSCompliant(true)]
	public class WiscrViewQuery : WiscrViewParameterBuilder
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the WiscrViewQuery class.
		/// </summary>
		public WiscrViewQuery() : base() { }

		/// <summary>
		/// Initializes a new instance of the WiscrViewQuery class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public WiscrViewQuery(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public WiscrViewQuery(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion WiscrViewQuery
	#endregion
