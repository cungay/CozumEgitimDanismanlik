...
{		
	...
	public partial class AreaServiceBase : ServiceBase<Area, AreaKey>
	{
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Area GetById(System.Int32 _ıd)
		{
            ...
            {	
				...
				entity = dataProvider.AreaProvider.GetById(transactionManager, _ıd)   as Area;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="Area"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Area GetById(System.Int32 _ıd, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetById");
            ...
            {	
				...
				entity = dataProvider.AreaProvider.GetById(transactionManager, _ıd, start, pageLength, out totalCount)   as Area;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// </summary>
		/// <param name="_ıd">Area pk id.</param>
		...
		public virtual bool Delete(System.Int32 _ıd)
		{
			...
			try
            {
				...
				result = dataProvider.AreaProvider.Delete(transactionManager, _ıd);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Area DeepLoadById(System.Int32 _ıd, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Area entity = GetById(_ıd);
